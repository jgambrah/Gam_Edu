...
console.log('--- Verifying Set 127 (1995 BECE Science) Locally ---');

// 1. Paper 1 Verification
const p1Questions = SET_BECE_1995_SCIENCE_P1.questions;
...
const p2Questions = SET_BECE_1995_SCIENCE_P2.questions;
...
// 3. SVG Checks
if (!svgQ1aCapillarityMeniscus.includes('<svg') || !svgQ1aCapillarityMeniscus.includes('Capillary Tube')) {
  throw new Error('svgQ1aCapillarityMeniscus is invalid or missing expected content');
}
console.log('✅ svgQ1aCapillarityMeniscus verified.');

if (!svgQ2aHumanEye.includes('<svg') || !svgQ2aHumanEye.includes('Crystalline Lens')) {
  throw new Error('svgQ2aHumanEye is invalid or missing expected content');
}
console.log('✅ svgQ2aHumanEye verified.');

console.log('🎉 ALL LOCAL VERIFICATION CHECKS PASSED FOR SET 127!');
