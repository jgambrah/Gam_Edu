...
async function seedBece2003SciencePaper2Only() {
  console.log('Seeding 2003 BECE Integrated Science Paper 2 Variant (Set 113) into Firestore...');
  ...
  await docRef.set({
    paper2: {
      ...
      durationMinutes: 75,
      instructions: "Answer four questions in all. Answer Question 1 (compulsory) and any other three questions from Section B. All working must be clearly shown.",
      totalQuestions: 4,
  ...
  console.log('✅ Successfully seeded Set 113 (2003 Science Paper 2 Variant) into past_papers/paper_2003_variant.');
  ...
  console.log('🎉 Set 113 (2003 Science Paper 2 Variant) dedicated ingestion complete!');
}

seedBece2003SciencePaper2Only()
  .then(() => process.exit(0))
  .catch((err) => {
    console.error('Failed ingestion for Set 113 Science Paper 2:', err);
    process.exit(1);
  });
