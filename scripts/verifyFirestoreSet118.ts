...
async function verifyFirestoreSet118() {
  console.log('=== VERIFYING FIRESTORE INGESTION FOR SET 118 ===');
  ...
  const p1Path = 'global_curriculum/jhs/subjects/science/topics/bece_past_papers/question_sets/paper_2025_variant_p1';
  ...
  const p2Path = 'global_curriculum/jhs/subjects/science/topics/bece_past_papers/question_sets/paper_2025_variant_p2';
  ...
  // 4. Check paper_2025_variant topic path root questions
  const topicPath = 'global_curriculum/jhs/subjects/science/topics/bece_past_papers/question_sets/paper_2025_variant';
  ...
  console.log('\n🎉 ALL FIRESTORE DATASETS VERIFIED SUCCESSFULLY!');
}

verifyFirestoreSet118()
  .then(() => process.exit(0))
  .catch(err => {
