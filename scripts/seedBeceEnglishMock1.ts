...
// =========================================================================
// 40 OBJECTIVE QUESTIONS: LEXIS, STRUCTURE, CLOZE & ORAL PHONOLOGY
// =========================================================================
    ...
    paper1: {
      ...
      sections: {
        ...
        sectionE_cloze_passage: {
          title: "Section E: Meeting Protocol Cloze Passage",
...
seedBeceEnglishMock1()
  .then(() => process.exit(0))
  .catch((err) => {
    console.error("❌ Failed to seed BECE English Mock 1:", err);
    process.exit(1);
  });
