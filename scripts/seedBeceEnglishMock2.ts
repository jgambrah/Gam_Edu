...
// =========================================================================
// 40 OBJECTIVE QUESTIONS: LEXIS, STRUCTURE, COURT CLOZE & ORAL PHONOLOGY
// =========================================================================
    ...
    paper1: {
      ...
      sections: {
        ...
        sectionE_cloze_passage: {
          title: "Section E: Courtroom Trial Cloze Passage",
...
seedBeceEnglishMock2()
  .then(() => process.exit(0))
  .catch((err) => {
    console.error("❌ Failed to seed BECE English Mock 2:", err);
    process.exit(1);
  });
