...
import { SET_BECE_2005_SCIENCE_P1 } from '../src/lib/data/jhs-curriculum-set-108';
import { SET_BECE_2005_SCIENCE_P2 } from '../src/lib/data/jhs-curriculum-set-109';
...
async function seedBece2005ScienceCompleteVariant() {
  console.log('Calibrating & Seeding 2005 BECE Integrated Science Complete Variant (Sets 108 & 109)...');
  const db = await getFirestore();

  // Verify balanced key distribution for Paper 1
  const keyDist: any = { A: 0, B: 0, C: 0, D: 0 };
  SET_BECE_2005_SCIENCE_P1.questions.forEach((q: any) => {
  ...
  await docRef.set({
    ...
    paper1: {
      ...
      durationMinutes: 45,
      totalQuestions: 40,
      questions: SET_BECE_2005_SCIENCE_P1.questions
    },
    paper2: {
  ...
  console.log('✅ Ingested into past_papers/paper_2005_variant.');

  // 2. Paper 1 single-doc read paths (Set 108)
  const p1Data = {
    ...SET_BECE_2005_SCIENCE_P1,
  ...
  const p1Paths = [
    ...
    'global_curriculum/jhs/subjects/science/topics/bece_past_papers/question_sets/paper_2005_variant_p1',
    'global_curriculum/jhs/subjects/science/topics/past_papers/question_sets/paper_2005_variant',
    'global_curriculum/jhs/subjects/science/topics/past_papers/question_sets/paper_2005_variant_p1',
    'global_curriculum/jhs/subjects/science/topics/bece_2005_variant/question_sets/paper_2005_variant',
    'global_curriculum/jhs/subjects/science/topics/bece_2005_variant/question_sets/paper_2005_variant_p1',
    'global_curriculum/jhs/subjects/integrated_science/topics/bece_past_papers/question_sets/paper_2005_variant',
    'global_curriculum/jhs/subjects/integrated_science/topics/bece_past_papers/question_sets/paper_2005_variant_p1',
    'global_curriculum/jhs/subjects/integrated_science/topics/past_papers/question_sets/paper_2005_variant',
    'global_curriculum/jhs/subjects/integrated_science/topics/past_papers/question_sets/paper_2005_variant_p1',
    'global_curriculum/jhs/subjects/integrated_science/topics/bece_2005_variant/question_sets/paper_2005_variant',
    'global_curriculum/jhs/subjects/integrated_science/topics/bece_2005_variant/question_sets/paper_2005_variant_p1',
  ];
  ...
  // 3. Paper 2 single-doc read paths (Set 109)
  const p2Data = {
  ...
  console.log('🎉 Set 108 & Set 109 (2005 Science Complete Variant) ingestion complete!');
}

seedBece2005ScienceCompleteVariant()
  .then(() => process.exit(0))
  .catch(err => {
    console.error('Failed ingestion for Set 108/109 Science Variant:', err);
    process.exit(1);
  });
