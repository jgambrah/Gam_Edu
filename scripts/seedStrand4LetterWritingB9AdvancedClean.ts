...
// Complex Address Layouts, Deictic Distinctions, Strict Co-Occurrence Constraints,
// Register Shifts, Punctuation Paradigms, and Administrative Petition Forensics
// =========================================================================
const rawObjective50Data = [
  ...
  },
  {
    ...
    options: ["18 November 2026", "18th November, 2026.", "18th November 2026", "November 18th, 2026."],
  ...
  },
  {
    ...
    options: ["Nana, / His Royal Majesty, / Dear Sir,", "Dear Chief Osei,", "Hello Nana Chief,", "Dear Mr. Paramount Chief,"],
  ...
  },
  {
    ...
    options: ["attend", "attends", "attended", "is attending"],
    answer: "attend",
  ...
  },
  {
    ...
    options: ["is traveling", "are traveling", "were traveling", "have traveled"],
    answer: "is traveling",
  ...
  },
  {
    ...
    options: ["Kwame", "Kwame Mensah", "Master Kwame Mensah", "K. Mensah (Student)"],
    answer: "Kwame",
  ...
  },
  {
    ...
    options: ["vacate", "vacates", "vacated", "is vacating"],
    answer: "vacate",
  ...
  },
  {
    ...
    options: ["The name of the institution/office (e.g., 'Tamale Metropolitan Assembly,')", "The name of the official's spouse", "The official's home address", "The date of establishment of the assembly"],
  ...
  },
  {
    ...
    options: ["Yours Sincerely,", "Yours sincerely,", "Yours faithfully,", "Your affectionate sister,"],
    answer: "Yours Sincerely,",
...
// Basic 9 Advanced Scaffolds & Model Letters (~250 words each)
// Aligned with WAEC / BECE Chief Examiner Distinction Criteria
// =========================================================================
const theory10Prompts: TheoryEssayItem[] = [
  // 51. Informal: Navigating Academic Competition & Peer Pressure
  {
    ...
    learningCompetency: "B9.4.2.1.1: Compose reflective personal letters evaluating peer dynamics, ethical academic integrity, and personal resilience.",
    ...
    guidanceScaffold: {
      ...
      bodyGuidance: {
        ...
        paragraphPrompts: [
          { paragraphIndex: 1, role: "preamble_opening", guidingQuestion: "Enquire warmly about his university studies and introduce the tense classroom atmosphere.", transitionHints: ["I hope this letter finds you thriving in your studies...", "As we enter the crucial final terms of Basic 9, the academic atmosphere has become..."] },
          { paragraphIndex: 2, role: "exposition_body_1", guidingQuestion: "Describe the toxic rivalry, hoarding of textbooks, and temptation toward test cheating.", transitionHints: ["Desperation for Category A school placement has fostered unhealthy rivalry...", "Some classmates have begun hoarding past question booklets and forming clandestine cheating syndicates..."] },
  ...
  // 52. Informal: The Ecological Value of Wetlands to a Pen Pal
  {
    ...
    learningCompetency: "B9.4.2.1.1: Compose descriptive personal letters detailing scientific field research, ecological sustainability, and wetland conservation.",
  ...
  // 53. Semi-Formal: Seeking Patronage for Community Coding Club
  {
    ...
    learningCompetency: "B9.4.2.1.2: Compose semi-formal institutional requests to corporate alumni demonstrating project vision, curriculum structure, and resource appeals.",
  ...
  // 54. Formal: Application for Student Welfare & Disciplinary Prefect
  {
    ...
    learningCompetency: "B9.4.2.1.2: Compose formal administrative applications demonstrating ethical self-advocacy, restorative justice advocacy, dual addresses, and quadripartite sign-offs.",
  ...
  // 56. Informal: Account of Inter-Schools Robotics Championship
  {
    ...
    learningCompetency: "B9.4.2.1.1: Compose friendly personal letters incorporating vivid narrative action, engineering problem-solving, and conversational warmth.",
  ...
  // 57. Semi-Formal: Seeking Partnership with Renewable Energy Firm
  {
    ...
    learningCompetency: "B9.4.2.1.2: Compose semi-formal institutional requests to corporate executives detailing engineering schematics, educational mentorship, and equipment appeals.",
  ...
  // 58. Formal: Application for Student Environmental Officer
  {
    ...
    learningCompetency: "B9.4.2.1.2: Compose formal administrative applications demonstrating ecological stewardship, waste management policies, dual addresses, and quadripartite sign-offs.",
  ...
  // 59. Civic Petition: Dangerous Quarry Blasting Shaking School Classrooms
  {
    ...
    learningCompetency: "B9.4.2.1.2: Compose forensic civic petitions to municipal authorities documenting public safety violations, structural damage, and regulatory enforcement prayers.",
  ...
  // 60. Formal Letter to Editor: Combating Teenage Truancy and Digital Gaming Addiction
  {
    ...
    learningCompetency: "B9.4.2.1.2: Compose formal letters to national newspaper editors analyzing contemporary social vices, regulatory lapses, and legislative solutions.",
...
async function deployStrand4B9AdvancedClean() {
  ...
  rawObjective50Data.slice(0, 50).forEach((item, index) => {
    ...
    all60Items.push({
      id: `B9_S4_A_OBJ_${qNum < 10 ? "0" + qNum : qNum}`,
      section: "objective",
      questionNumber: qNum,
      type: "multiple_choice",
      format: "multiple_choice",
      ...
      learningCompetency: "B9.4.2.1: Demonstrate advanced mastery of epistolary formatting, address architecture, dating laws, salutation/close pairings, and caption rules."
    });
  });
  ...
  const labPayload = {
    level: "B9",
    difficulty: "advanced",
    title: "Basic 9 Advanced Writing Lab: 50 Objective Drills + 10 Theory Writing Tasks",
