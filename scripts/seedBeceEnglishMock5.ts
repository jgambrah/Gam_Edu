// Auto-generated BECE English Mock 5 Seed Script
// Primary doc: global_curriculum/jhs/subjects/english/mocks/mock_5
export const MOCK_5_PAYLOAD = {
  "mockId": "mock_5",
  "mockNumber": 5,
  ...
  "metadata": {
    ...
    "updatedAt": "2026-09-23T18:19:23.450Z"
  },
  "paper1": {
    ...
    "sections": {
      ...
      "sectionB_synonyms": {
        ...
        "questions": [
          {
            "number": 16,
            "prompt": "Despite insurmountable obstacles, the young inventor remained tenacious in his scientific research.\nChoose the word nearest in meaning to 'tenacious'.",
            "options": [
              "stubborn",
              "cautious",
              "fearful",
            ...
            "hint": "Tending to keep a firm hold of something; clinging or adhering closely; persistent.",
            "workedSolution": "'Tenacious' means determined, resolute, and unwavering; 'persistent' is its direct positive synonym.",
            "points": 1
          },
          {
            "number": 17,
            "prompt": "The monastic community was known for its austere lifestyle and dedication to prayer.\nChoose the word nearest in meaning to 'austere'.",
            "options": [
              "peaceful",
              "severe",
              "humble",
            ...
            "hint": "Strict, plain, and without luxury or comfort.",
            "workedSolution": "'Austere' in describing a lifestyle or regimen means simple, rigorous, or 'severe'; 'severe' is its closest synonym.",
            "points": 1
          },
          {
            "number": 18,
            "prompt": "Smartphones have become ubiquitous across contemporary urban communities.\nChoose the word nearest in meaning to 'ubiquitous'.",
            "options": [
              "popular",
              "expensive",
              "omnipresent",
            ...
            "workedSolution": "'Ubiquitous' means existing or being encountered everywhere; 'omnipresent' is its exact philosophical and lexical equivalent.",
            "points": 1
          },
          {
            "number": 19,
            "prompt": "Constructing the mountain road through jagged granite boulders proved to be an arduous undertaking.\nChoose the word nearest in meaning to 'arduous'.",
            "options": [
              "tedious",
              "strenuous",
              "perilous",
          ...
          {
            "number": 20,
            "prompt": "The headmistress gave a candid evaluation of the school's mock examination performance.\nChoose the word nearest in meaning to 'candid'.",
            "options": [
              "polite",
              "frank",
              "critical",
            ...
            "correctAnswer": "frank",
            "hint": "Truthful, direct, and straightforward; outspoken.",
  ...
  "paper2": {
        ...
        "questions": [
          {
            ...
            "contextExtract": "\"Nancy grabbed the boy's arm tightly in the dark alley. 'Make one sound, Oliver,' whispered Bill Sikes, cocking his pistol, 'and this bullet goes straight through your head!'\"",
            "subItems": [
              {
                "subQuestion": "5(a)",
                "question": "Where was Oliver Twist heading on an errand when he was violently recaptured by Nancy and Bill Sikes?",
                "answer": "He was on an errand for Mr. Brownlow to return books and pay five pounds at the bookshop."
              },
              {
                "subQuestion": "5(b)",
                "question": "What contrasting emotions did Nancy experience toward Oliver during this criminal abduction?",
                "answer": "She felt deep pity, guilt, and protective affection for Oliver, yet she acted out of paralyzing terror of Bill Sikes' brutal violence."
              }
            ]
          },
          {
            "sectionTitle": "AMA ATA AIDOO: The Dilemma of a Ghost",
            "contextExtract": "NANA: \"My spirit Mother ought to have come for me earlier. Now, what shall I tell them who are gone? The daughter of slaves who come from the white man's land...\"",
            "subItems": [
              {
                "subQuestion": "5(c)",
                "question": "What cultural dilemma is Nana lamenting in this opening soliloquy?",
                "answer": "The shame and ancestral catastrophe of Ato marrying a descendant of slaves from America rather than a native bride from their clan."
              },
              {
                "subQuestion": "5(d)",
                "question": "Who does the phrase 'them who are gone' refer to?",
                "answer": "The deceased ancestors and departed spirits of the Odumna clan."
              }
            ]
          },
          {
            ...
            "subItems": [
              {
                "subQuestion": "5(e)",
                "question": "Identify the literary device used in the line: 'Be courageous, be courageous, Kwame, be courageous!'",
                "answer": "Repetition (or epizeuxis)."
              },
              {
                "subQuestion": "5(f)",
                "question": "What physical weapon symbolized the paternal legacy that Kwame was commanded to 'hold on to'?",
                "answer": "His late father's hunting gun."
              }
            ]
          },
          {
            ...
            "subItems": [
              {
                "subQuestion": "5(g)",
                "question": "Identify the primary figure of speech in the line: 'Dakuna will soon float on a sea of wealth.'",
                "answer": "Hyperbole (or metaphor)."
              },
              {
                "subQuestion": "5(h)",
                "question": "Why was the speaker's prediction of wealth for Dakuna deeply ironic?",
                "answer": "Because Dakuna was an impoverished, neglected village mired in squalor and destitution, and the narrator's return could not change its poverty."
              }
            ]
          },
          {
            ...
            "subItems": [
              {
                "subQuestion": "5(i)",
                "question": "What type of poem is 'Sleep Without Wake'?",
                "answer": "An elegy (or dirge / mourning poem for the dead)."
              },
              {
                "subQuestion": "5(j)",
                "question": "The rhythmic words 'Taa taa, tuu tuu' appeal primarily to the reader's sense of ............",
                "answer": "hearing (auditory imagery) and touch/motion (tactile/kinetic imagery)."
              }
            ]
          }
        ]
    ...
    "questions": [
      ...
      },
      {
        ...
        "prompt": "Write an article for publication in a national daily newspaper on the topic: \"The Impact of Excessive Smartphone Screen Time on Adolescent Mental Health and Academic Performance in Ghana.\"",
        "markingScheme": "BREAKING THE DIGITAL SHACKLES: SMARTPHONES AND ADOLESCENT WELFARE\nBy Samuel K. Boateng, Begoro\n\nThe twenty-first century has witnessed an extraordinary revolution in handheld telecommunications, placing powerful internet-connected smartphones into the hands of millions of Ghanaian basic and secondary school students. While digital connectivity offers valuable academic research tools, the alarming addiction to excessive smartphone screen time has emerged as a severe crisis undermining adolescent mental health and scholastic performance.\n\nThe foremost tragedy resulting from digital screen addiction is the acute fragmentation of students' attention spans and academic momentum. Adolescents spend six to eight continuous hours daily scrolling through ephemeral social media videos, video games, and gossip blogs. This perpetual digital stimulation conditions young brains to crave instant gratification, eroding their capacity for sustained cognitive focus. When faced with demanding textbooks in Mathematics, English Language, or Integrated Science, addicted students experience extreme mental fatigue, restlessness, and boredom. Homework assignments are neglected or completed superficially using artificial intelligence shortcuts, directly precipitating mass failure in national examinations like the BECE.\n\nSecondly, excessive nocturnal screen time inflicts severe psychological damage and sleep deprivation. The high-energy blue light emitted by smartphone screens suppresses melatonin secretion, preventing teenagers from achieving restorative sleep. Chronic sleep deficit causes severe mood swings, cognitive fog, social anxiety, and depressive disorders. Furthermore, constant exposure to curated, unrealistic luxury lifestyles on social media breeds toxic inferiority complexes, jealousy, and low self-esteem among vulnerable youth.\n\nTo protect our youth, parents must enforce strict household screen-time curfews, barring smartphones from bedrooms after 8:00 p.m. Schools must ban personal mobile devices on campus and revitalize library reading hours and outdoor sports.\n\nA smartphone is a tool for empowerment, not a digital master; our adolescents must reclaim their mental freedom.",
        "sampleAnswer": "BREAKING THE DIGITAL SHACKLES: SMARTPHONES AND ADOLESCENT WELFARE\nBy Samuel K. Boateng, Begoro\n\nThe twenty-first century has witnessed an extraordinary revolution in handheld telecommunications, placing powerful internet-connected smartphones into the hands of millions of Ghanaian basic and secondary school students. While digital connectivity offers valuable academic research tools, the alarming addiction to excessive smartphone screen time has emerged as a severe crisis undermining adolescent mental health and scholastic performance.\n\nThe foremost tragedy resulting from digital screen addiction is the acute fragmentation of students' attention spans and academic momentum. Adolescents spend six to eight continuous hours daily scrolling through ephemeral social media videos, video games, and gossip blogs. This perpetual digital stimulation conditions young brains to crave instant gratification, eroding their capacity for sustained cognitive focus. When faced with demanding textbooks in Mathematics, English Language, or Integrated Science, addicted students experience extreme mental fatigue, restlessness, and boredom. Homework assignments are neglected or completed superficially using artificial intelligence shortcuts, directly precipitating mass failure in national examinations like the BECE.\n\nSecondly, excessive nocturnal screen time inflicts severe psychological damage and sleep deprivation. The high-energy blue light emitted by smartphone screens suppresses melatonin secretion, preventing teenagers from achieving restorative sleep. Chronic sleep deficit causes severe mood swings, cognitive fog, social anxiety, and depressive disorders. Furthermore, constant exposure to curated, unrealistic luxury lifestyles on social media breeds toxic inferiority complexes, jealousy, and low self-esteem among vulnerable youth.\n\nTo protect our youth, parents must enforce strict household screen-time curfews, barring smartphones from bedrooms after 8:00 p.m. Schools must ban personal mobile devices on campus and revitalize library reading hours and outdoor sports.\n\nA smartphone is a tool for empowerment, not a digital master; our adolescents must reclaim their mental freedom.",
        "workedSolution": "BREAKING THE DIGITAL SHACKLES: SMARTPHONES AND ADOLESCENT WELFARE\nBy Samuel K. Boateng, Begoro\n\nThe twenty-first century has witnessed an extraordinary revolution in handheld telecommunications, placing powerful internet-connected smartphones into the hands of millions of Ghanaian basic and secondary school students. While digital connectivity offers valuable academic research tools, the alarming addiction to excessive smartphone screen time has emerged as a severe crisis undermining adolescent mental health and scholastic performance.\n\nThe foremost tragedy resulting from digital screen addiction is the acute fragmentation of students' attention spans and academic momentum. Adolescents spend six to eight continuous hours daily scrolling through ephemeral social media videos, video games, and gossip blogs. This perpetual digital stimulation conditions young brains to crave instant gratification, eroding their capacity for sustained cognitive focus. When faced with demanding textbooks in Mathematics, English Language, or Integrated Science, addicted students experience extreme mental fatigue, restlessness, and boredom. Homework assignments are neglected or completed superficially using artificial intelligence shortcuts, directly precipitating mass failure in national examinations like the BECE.\n\nSecondly, excessive nocturnal screen time inflicts severe psychological damage and sleep deprivation. The high-energy blue light emitted by smartphone screens suppresses melatonin secretion, preventing teenagers from achieving restorative sleep. Chronic sleep deficit causes severe mood swings, cognitive fog, social anxiety, and depressive disorders. Furthermore, constant exposure to curated, unrealistic luxury lifestyles on social media breeds toxic inferiority complexes, jealousy, and low self-esteem among vulnerable youth.\n\nTo protect our youth, parents must enforce strict household screen-time curfews, barring smartphones from bedrooms after 8:00 p.m. Schools must ban personal mobile devices on campus and revitalize library reading hours and outdoor sports.\n\nA smartphone is a tool for empowerment, not a digital master; our adolescents must reclaim their mental freedom.",
        "points": 30
      },
      {
        "number": 3,
        ...
        "prompt": "Write an engaging, realistic story that illustrates the traditional proverb: \"Make hay while the sun shines.\"",
        "markingScheme": "MAKE HAY WHILE THE SUN SHINES\n\nDuring our final academic year in junior high school, my childhood desk-mate, Kofi, and I were presented with an extraordinary opportunity. Our school was selected to participate in a funded preparatory scholarship clinic organized by the Municipal Education Directorate. The project provided five months of intensive weekend tutorials and free access to a modern science laboratory to prepare candidates for the national BECE.\n\nRecognizing the immense value of this opportunity, I resolved to dedicate every ounce of my energy to it. Remembering my grandmother's timeless admonition to \"make hay while the sun shines,\" I gave up weekend video games and social excursions, attending every Saturday tutorial punctually and completing five past examination booklets weekly.\n\nKofi, on the other hand, displayed reckless procrastination. He scoffed at my diligence, boasting that there was abundant time before the final examinations. He spent his Saturday afternoons loitering at commercial game centers and attending street carnivals, laughing mockingly: \"The BECE is still months away; why waste your youthful energy memorizing notes in a stuffy hall?\"\n\nThe day of reckoning arrived with brutal suddenness. Three weeks before the national examinations, a violent family dispute erupted in Kofi's home. His parents separated, their family shop collapsed financially, and his domestic environment turned into chaotic turmoil. Paralyzed by stress and anxiety, Kofi tried to cram the entire three-year syllabus into two sleepless weeks. His exhausted mind could not absorb the material; he experienced severe panic attacks in the examination hall, confusing basic formulas and weeping over his question papers.\n\nWhen the national results were officially declared, I passed with Aggregate Six, earning an elite government scholarship to Prempeh College. Kofi failed Mathematics and Science, missing senior high school placement completely. Watching him trudge dejectedly toward an informal apprenticeship, the ancient proverb resonated in my heart: Truly, we must make hay while the sun shines.",
        "sampleAnswer": "MAKE HAY WHILE THE SUN SHINES\n\nDuring our final academic year in junior high school, my childhood desk-mate, Kofi, and I were presented with an extraordinary opportunity. Our school was selected to participate in a funded preparatory scholarship clinic organized by the Municipal Education Directorate. The project provided five months of intensive weekend tutorials and free access to a modern science laboratory to prepare candidates for the national BECE.\n\nRecognizing the immense value of this opportunity, I resolved to dedicate every ounce of my energy to it. Remembering my grandmother's timeless admonition to \"make hay while the sun shines,\" I gave up weekend video games and social excursions, attending every Saturday tutorial punctually and completing five past examination booklets weekly.\n\nKofi, on the other hand, displayed reckless procrastination. He scoffed at my diligence, boasting that there was abundant time before the final examinations. He spent his Saturday afternoons loitering at commercial game centers and attending street carnivals, laughing mockingly: \"The BECE is still months away; why waste your youthful energy memorizing notes in a stuffy hall?\"\n\nThe day of reckoning arrived with brutal suddenness. Three weeks before the national examinations, a violent family dispute erupted in Kofi's home. His parents separated, their family shop collapsed financially, and his domestic environment turned into chaotic turmoil. Paralyzed by stress and anxiety, Kofi tried to cram the entire three-year syllabus into two sleepless weeks. His exhausted mind could not absorb the material; he experienced severe panic attacks in the examination hall, confusing basic formulas and weeping over his question papers.\n\nWhen the national results were officially declared, I passed with Aggregate Six, earning an elite government scholarship to Prempeh College. Kofi failed Mathematics and Science, missing senior high school placement completely. Watching him trudge dejectedly toward an informal apprenticeship, the ancient proverb resonated in my heart: Truly, we must make hay while the sun shines.",
        "workedSolution": "MAKE HAY WHILE THE SUN SHINES\n\nDuring our final academic year in junior high school, my childhood desk-mate, Kofi, and I were presented with an extraordinary opportunity. Our school was selected to participate in a funded preparatory scholarship clinic organized by the Municipal Education Directorate. The project provided five months of intensive weekend tutorials and free access to a modern science laboratory to prepare candidates for the national BECE.\n\nRecognizing the immense value of this opportunity, I resolved to dedicate every ounce of my energy to it. Remembering my grandmother's timeless admonition to \"make hay while the sun shines,\" I gave up weekend video games and social excursions, attending every Saturday tutorial punctually and completing five past examination booklets weekly.\n\nKofi, on the other hand, displayed reckless procrastination. He scoffed at my diligence, boasting that there was abundant time before the final examinations. He spent his Saturday afternoons loitering at commercial game centers and attending street carnivals, laughing mockingly: \"The BECE is still months away; why waste your youthful energy memorizing notes in a stuffy hall?\"\n\nThe day of reckoning arrived with brutal suddenness. Three weeks before the national examinations, a violent family dispute erupted in Kofi's home. His parents separated, their family shop collapsed financially, and his domestic environment turned into chaotic turmoil. Paralyzed by stress and anxiety, Kofi tried to cram the entire three-year syllabus into two sleepless weeks. His exhausted mind could not absorb the material; he experienced severe panic attacks in the examination hall, confusing basic formulas and weeping over his question papers.\n\nWhen the national results were officially declared, I passed with Aggregate Six, earning an elite government scholarship to Prempeh College. Kofi failed Mathematics and Science, missing senior high school placement completely. Watching him trudge dejectedly toward an informal apprenticeship, the ancient proverb resonated in my heart: Truly, we must make hay while the sun shines.",
        "points": 30
      },
      {
        "number": 4,
        ...
        "prompt": "In the agrarian economy of West Africa, cassava represents far more than an ordinary agricultural crop; it is the ultimate food security anchor that shields rural households from catastrophic starvation. Cultivated widely across tropical rainforest and guinea savannah belts, this hardy woody shrub possesses an extraordinary physiological capacity to thrive in impoverished soils and withstand extreme drought conditions that wither delicate cereals such as maize and rice.\n\nThe true agricultural supremacy of cassava lies in its remarkable agronomic resilience. Unlike grains that demand expensive chemical fertilizers, predictable rainfall, and meticulous pest management, cassava requires minimal capital investment. Farmers propagate the crop easily by inserting woody stem cuttings into mounds of red loam soil. Once established, its deep fibrous root system penetrates underground moisture reserves, allowing the plant to survive prolonged dry spells. Furthermore, mature cassava tubers can remain safely stored beneath the soil for up to twenty-four months without decaying, functioning as a living, underground biological storage bank that rural families harvest gradually during seasonal famines.\n\nBeyond household sustenance, cassava serves as a dynamic catalyst for rural industrialization and commercial agro-processing. Through labor-intensive traditional techniques, rural women transform raw tubers into diverse culinary staples, such as fermented gari, kokonte flour, and fufu dough. In contemporary industrial manufacture, refined cassava starch is extracted for commercial applications in textile sizing, pharmaceutical tablet binding, paper manufacturing, and the brewing of alcoholic beverages.\n\nHowever, the cassava value chain faces significant biological and logistical vulnerabilities. The foremost menace is the rampant spread of Cassava Mosaic Disease (CMD) and Cassava Brown Streak Disease (CBSD), viral epidemics transmitted by whiteflies that stunt plant growth and rot tubers before harvest. Furthermore, because harvested tubers contain eighty percent moisture, they suffer rapid post-harvest physiological deterioration, spoiling completely within forty-eight hours of excavation unless processed immediately.\n\nAgricultural research institutes emphasize that transforming cassava from a subsistence security crop into a commercial agro-industrial powerhouse requires modern interventions. Governments must distribute disease-resistant hybrid stem cuttings to farmers, establish rural solar-powered processing hubs near farm gates, and rehabilitate eroded feeder roads to ensure swift transportation to urban factory depots.",
        "passage": "In the agrarian economy of West Africa, cassava represents far more than an ordinary agricultural crop; it is the ultimate food security anchor that shields rural households from catastrophic starvation. Cultivated widely across tropical rainforest and guinea savannah belts, this hardy woody shrub possesses an extraordinary physiological capacity to thrive in impoverished soils and withstand extreme drought conditions that wither delicate cereals such as maize and rice.\n\nThe true agricultural supremacy of cassava lies in its remarkable agronomic resilience. Unlike grains that demand expensive chemical fertilizers, predictable rainfall, and meticulous pest management, cassava requires minimal capital investment. Farmers propagate the crop easily by inserting woody stem cuttings into mounds of red loam soil. Once established, its deep fibrous root system penetrates underground moisture reserves, allowing the plant to survive prolonged dry spells. Furthermore, mature cassava tubers can remain safely stored beneath the soil for up to twenty-four months without decaying, functioning as a living, underground biological storage bank that rural families harvest gradually during seasonal famines.\n\nBeyond household sustenance, cassava serves as a dynamic catalyst for rural industrialization and commercial agro-processing. Through labor-intensive traditional techniques, rural women transform raw tubers into diverse culinary staples, such as fermented gari, kokonte flour, and fufu dough. In contemporary industrial manufacture, refined cassava starch is extracted for commercial applications in textile sizing, pharmaceutical tablet binding, paper manufacturing, and the brewing of alcoholic beverages.\n\nHowever, the cassava value chain faces significant biological and logistical vulnerabilities. The foremost menace is the rampant spread of Cassava Mosaic Disease (CMD) and Cassava Brown Streak Disease (CBSD), viral epidemics transmitted by whiteflies that stunt plant growth and rot tubers before harvest. Furthermore, because harvested tubers contain eighty percent moisture, they suffer rapid post-harvest physiological deterioration, spoiling completely within forty-eight hours of excavation unless processed immediately.\n\nAgricultural research institutes emphasize that transforming cassava from a subsistence security crop into a commercial agro-industrial powerhouse requires modern interventions. Governments must distribute disease-resistant hybrid stem cuttings to farmers, establish rural solar-powered processing hubs near farm gates, and rehabilitate eroded feeder roads to ensure swift transportation to urban factory depots.",
        "subQuestions": [
          {
            "label": "(a)",
            "question": "State two specific environmental or soil conditions under which cassava can survive successfully according to the passage.",
        ...
        "markingScheme": "(a) State two specific environmental or soil conditions under which cassava can survive successfully according to the passage.\nAnswer: Cassava can thrive in impoverished (poor) soils and withstand extreme drought conditions (prolonged dry spells).\n\n(b) Why do agriculturalists describe mature cassava tubers as 'a living, underground biological storage bank'?\nAnswer: Because mature tubers can remain stored safely beneath the soil for up to twenty-four months without rotting, allowing families to harvest them gradually when food is scarce.\n\n(c) Mention two industrial or commercial manufacturing uses of refined cassava starch.\nAnswer: 1. Sizing in textile manufacturing.\n2. Binding agent in pharmaceutical tablets (or paper manufacturing / brewing alcoholic beverages).\n\n(d) What primary factor causes harvested cassava tubers to spoil within forty-eight hours of excavation?\nAnswer: Harvested tubers contain a high moisture content of eighty percent, which triggers rapid post-harvest physiological deterioration.\n\n(e) Explain the meaning of the following expressions as used in the passage:\nI. ... food security anchor;\nII. ... with impunity;\nIII. ... living up to expectations.\nAnswer: I. 'food security anchor' means a dependable, vital agricultural safeguard that protects people from hunger and famine.\nII. 'minimal capital investment' means very little money, expenditure, or financial resources required.\nIII. 'swift transportation' means fast, prompt, and rapid conveyance of goods.\n\n(f) For each of the following words, give another word or phrase that means the same and can fit into the passage:\nI. resilience;\nII. propagate;\nIII. sustenance;\nIV. vulnerabilities.\nAnswer: I. resilience: toughness, endurance, hardiness, adaptability.\nII. propagate: cultivate, reproduce, breed, grow.\nIII. sustenance: food, nourishment, survival, livelihood.\nIV. vulnerabilities: weaknesses, hazards, risks, frailties.\n\n(g) In two concise sentences of NOT MORE THAN EIGHT WORDS EACH, summarize the two major challenges confronting cassava production.\nAnswer: 1. Destructive viral diseases stunt crop growth.\n2. Harvested tubers rot rapidly within two days.",
        "workedSolution": "(a) State two specific environmental or soil conditions under which cassava can survive successfully according to the passage.\nAnswer: Cassava can thrive in impoverished (poor) soils and withstand extreme drought conditions (prolonged dry spells).\n\n(b) Why do agriculturalists describe mature cassava tubers as 'a living, underground biological storage bank'?\nAnswer: Because mature tubers can remain stored safely beneath the soil for up to twenty-four months without rotting, allowing families to harvest them gradually when food is scarce.\n\n(c) Mention two industrial or commercial manufacturing uses of refined cassava starch.\nAnswer: 1. Sizing in textile manufacturing.\n2. Binding agent in pharmaceutical tablets (or paper manufacturing / brewing alcoholic beverages).\n\n(d) What primary factor causes harvested cassava tubers to spoil within forty-eight hours of excavation?\nAnswer: Harvested tubers contain a high moisture content of eighty percent, which triggers rapid post-harvest physiological deterioration.\n\n(e) Explain the meaning of the following expressions as used in the passage:\nI. ... food security anchor;\nII. ... with impunity;\nIII. ... living up to expectations.\nAnswer: I. 'food security anchor' means a dependable, vital agricultural safeguard that protects people from hunger and famine.\nII. 'minimal capital investment' means very little money, expenditure, or financial resources required.\nIII. 'swift transportation' means fast, prompt, and rapid conveyance of goods.\n\n(f) For each of the following words, give another word or phrase that means the same and can fit into the passage:\nI. resilience;\nII. propagate;\nIII. sustenance;\nIV. vulnerabilities.\nAnswer: I. resilience: toughness, endurance, hardiness, adaptability.\nII. propagate: cultivate, reproduce, breed, grow.\nIII. sustenance: food, nourishment, survival, livelihood.\nIV. vulnerabilities: weaknesses, hazards, risks, frailties.\n\n(g) In two concise sentences of NOT MORE THAN EIGHT WORDS EACH, summarize the two major challenges confronting cassava production.\nAnswer: 1. Destructive viral diseases stunt crop growth.\n2. Harvested tubers rot rapidly within two days.",
        "points": 30
      },
      {
        "number": 5,
        ...
        "prompt": "Text: CHARLES DICKENS: Oliver Twist\nExtract: \"Nancy grabbed the boy's arm tightly in the dark alley. 'Make one sound, Oliver,' whispered Bill Sikes, cocking his pistol, 'and this bullet goes straight through your head!'\"\n\n5(a) Where was Oliver Twist heading on an errand when he was violently recaptured by Nancy and Bill Sikes?\n5(b) What contrasting emotions did Nancy experience toward Oliver during this criminal abduction?",
        "contextExtract": "\"Nancy grabbed the boy's arm tightly in the dark alley. 'Make one sound, Oliver,' whispered Bill Sikes, cocking his pistol, 'and this bullet goes straight through your head!'\"",
        "subQuestions": [
          {
            "label": "5(a)",
        ...
        "markingScheme": "5(a) Where was Oliver Twist heading on an errand when he was violently recaptured by Nancy and Bill Sikes?\nAnswer: He was on an errand for Mr. Brownlow to return books and pay five pounds at the bookshop.\n\n5(b) What contrasting emotions did Nancy experience toward Oliver during this criminal abduction?\nAnswer: She felt deep pity, guilt, and protective affection for Oliver, yet she acted out of paralyzing terror of Bill Sikes' brutal violence.",
        "workedSolution": "5(a) Where was Oliver Twist heading on an errand when he was violently recaptured by Nancy and Bill Sikes?\nAnswer: He was on an errand for Mr. Brownlow to return books and pay five pounds at the bookshop.\n\n5(b) What contrasting emotions did Nancy experience toward Oliver during this criminal abduction?\nAnswer: She felt deep pity, guilt, and protective affection for Oliver, yet she acted out of paralyzing terror of Bill Sikes' brutal violence.",
        "points": 10
      },
      {
        "number": 6,
        ...
        "prompt": "Text: AMA ATA AIDOO: The Dilemma of a Ghost\nExtract: NANA: \"My spirit Mother ought to have come for me earlier. Now, what shall I tell them who are gone? The daughter of slaves who come from the white man's land...\"\n\n5(c) What cultural dilemma is Nana lamenting in this opening soliloquy?\n5(d) Who does the phrase 'them who are gone' refer to?",
        "contextExtract": "NANA: \"My spirit Mother ought to have come for me earlier. Now, what shall I tell them who are gone? The daughter of slaves who come from the white man's land...\"",
        "subQuestions": [
          {
            "label": "5(c)",
        ...
        "markingScheme": "5(c) What cultural dilemma is Nana lamenting in this opening soliloquy?\nAnswer: The shame and ancestral catastrophe of Ato marrying a descendant of slaves from America rather than a native bride from their clan.\n\n5(d) Who does the phrase 'them who are gone' refer to?\nAnswer: The deceased ancestors and departed spirits of the Odumna clan.",
        "workedSolution": "5(c) What cultural dilemma is Nana lamenting in this opening soliloquy?\nAnswer: The shame and ancestral catastrophe of Ato marrying a descendant of slaves from America rather than a native bride from their clan.\n\n5(d) Who does the phrase 'them who are gone' refer to?\nAnswer: The deceased ancestors and departed spirits of the Odumna clan.",
        "points": 10
      },
      {
        "number": 7,
        "part": "Part C",
        "title": "Question 5(c): KAAKYIRE AKOSOMO NYANTAKYI: Tell My Son to Hold On to His Gun",
        "prompt": "Text: KAAKYIRE AKOSOMO NYANTAKYI: Tell My Son to Hold On to His Gun\nExtract: \"Be courageous, be courageous, Kwame, be courageous!\"\n\"I will be, Father, I will be\" I answered,\nand entered the thick forest......\n\n5(e) Identify the literary device used in the line: 'Be courageous, be courageous, Kwame, be courageous!'\n5(f) What physical weapon symbolized the paternal legacy that Kwame was commanded to 'hold on to'?",
        "contextExtract": "\"Be courageous, be courageous, Kwame, be courageous!\"\n\"I will be, Father, I will be\" I answered,\nand entered the thick forest......",
        "subQuestions": [
          {
            "label": "5(e)",
        ...
        "markingScheme": "5(e) Identify the literary device used in the line: 'Be courageous, be courageous, Kwame, be courageous!'\nAnswer: Repetition (or epizeuxis).\n\n5(f) What physical weapon symbolized the paternal legacy that Kwame was commanded to 'hold on to'?\nAnswer: His late father's hunting gun.",
        "workedSolution": "5(e) Identify the literary device used in the line: 'Be courageous, be courageous, Kwame, be courageous!'\nAnswer: Repetition (or epizeuxis).\n\n5(f) What physical weapon symbolized the paternal legacy that Kwame was commanded to 'hold on to'?\nAnswer: His late father's hunting gun.",
        "points": 10
      },
      {
        "number": 8,
        "part": "Part C",
        "title": "Question 5(d): KEN SARO-WIWA: Home Sweet Home",
        "prompt": "Text: KEN SARO-WIWA: Home Sweet Home\nExtract: \"Bom, say, our young Miss has arrived heavily laden with all the good things of the earth. I should think Dakuna will soon float on a sea of wealth.\"\n\n5(g) Identify the primary figure of speech in the line: 'Dakuna will soon float on a sea of wealth.'\n5(h) Why was the speaker's prediction of wealth for Dakuna deeply ironic?",
        "contextExtract": "\"Bom, say, our young Miss has arrived heavily laden with all the good things of the earth. I should think Dakuna will soon float on a sea of wealth.\"",
        "subQuestions": [
          {
            "label": "5(g)",
        ...
        "markingScheme": "5(g) Identify the primary figure of speech in the line: 'Dakuna will soon float on a sea of wealth.'\nAnswer: Hyperbole (or metaphor).\n\n5(h) Why was the speaker's prediction of wealth for Dakuna deeply ironic?\nAnswer: Because Dakuna was an impoverished, neglected village mired in squalor and destitution, and the narrator's return could not change its poverty.",
        "workedSolution": "5(g) Identify the primary figure of speech in the line: 'Dakuna will soon float on a sea of wealth.'\nAnswer: Hyperbole (or metaphor).\n\n5(h) Why was the speaker's prediction of wealth for Dakuna deeply ironic?\nAnswer: Because Dakuna was an impoverished, neglected village mired in squalor and destitution, and the narrator's return could not change its poverty.",
        "points": 10
      },
      {
        "number": 9,
        "part": "Part C",
        "title": "Question 5(e): A. A. AMOAKO: Sleep Without Wake",
        "prompt": "Text: A. A. AMOAKO: Sleep Without Wake\nExtract: \"You put me through my infant paces\nOn Gold Coast Ga ShikpƆŋ\nTaa taa, tuu tuu, in your maternal steps,\nMaame Tutuaa, condolences!\"\n\n5(i) What type of poem is 'Sleep Without Wake'?\n5(j) The rhythmic words 'Taa taa, tuu tuu' appeal primarily to the reader's sense of ............",
        "contextExtract": "\"You put me through my infant paces\nOn Gold Coast Ga ShikpƆŋ\nTaa taa, tuu tuu, in your maternal steps,\nMaame Tutuaa, condolences!\"",
        "subQuestions": [
          {
            "label": "5(i)",
        ...
        "markingScheme": "5(i) What type of poem is 'Sleep Without Wake'?\nAnswer: An elegy (or dirge / mourning poem for the dead).\n\n5(j) The rhythmic words 'Taa taa, tuu tuu' appeal primarily to the reader's sense of ............\nAnswer: hearing (auditory imagery) and touch/motion (tactile/kinetic imagery).",
        "workedSolution": "5(i) What type of poem is 'Sleep Without Wake'?\nAnswer: An elegy (or dirge / mourning poem for the dead).\n\n5(j) The rhythmic words 'Taa taa, tuu tuu' appeal primarily to the reader's sense of ............\nAnswer: hearing (auditory imagery) and touch/motion (tactile/kinetic imagery).",
        "points": 10
      }
    ]
  }
