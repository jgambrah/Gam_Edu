...
async function seedBece2013SciencePaper1Variant() {
  console.log('Seeding 2013 BECE Integrated Science Paper 1 Variant (Set 90) into Firestore...');
  ...
  console.log('✅ Ingestion complete: 2013 Science Paper 1 Variant seeded with exact 10A/10B/10C/10D distribution.');
}

seedBece2013SciencePaper1Variant()
  .then(() => process.exit(0))
  .catch(err => {
    console.error('Failed ingestion for Set 90 Science Paper 1:', err);
    process.exit(1);
  });
