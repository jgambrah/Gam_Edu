...
const svgQ7NumberLineVar = `<svg viewBox='0 0 360 80' width='100%' height='80' xmlns='http://www.w3.org/2000/svg'><rect width='100%' height='100%' rx='6' fill='#f8fafc' stroke='#cbd5e1' stroke-width='1.5'/><line x1='30' y1='45' x2='330' y2='45' stroke='#1e293b' stroke-width='2'/><polygon points='30,41 22,45 30,49' fill='#1e293b'/><polygon points='330,41 338,45 330,49' fill='#1e293b'/><line x1='50' y1='38' x2='50' y2='52' stroke='#475569' stroke-width='1.5'/><text x='50' y='65' font-size='10' fill='#334155' text-anchor='middle'>-4</text><line x1='85' y1='38' x2='85' y2='52' stroke='#475569' stroke-width='1.5'/><text x='85' y='65' font-size='10' fill='#334155' text-anchor='middle'>-3</text><line x1='120' y1='38' x2='120' y2='52' stroke='#475569' stroke-width='1.5'/><text x='120' y='65' font-size='10' fill='#334155' text-anchor='middle'>-2</text><line x1='155' y1='38' x2='155' y2='52' stroke='#475569' stroke-width='1.5'/><text x='155' y='65' font-size='10' fill='#334155' text-anchor='middle'>-1</text><line x1='190' y1='38' x2='190' y2='52' stroke='#475569' stroke-width='1.5'/><text x='190' y='65' font-size='10' fill='#334155' text-anchor='middle'>0</text><line x1='225' y1='38' x2='225' y2='52' stroke='#475569' stroke-width='1.5'/><text x='225' y='65' font-size='10' fill='#334155' text-anchor='middle'>1</text><line x1='260' y1='38' x2='260' y2='52' stroke='#475569' stroke-width='1.5'/><text x='260' y='65' font-size='10' fill='#334155' text-anchor='middle'>2</text><line x1='295' y1='38' x2='295' y2='52' stroke='#475569' stroke-width='1.5'/><text x='295' y='65' font-size='10' fill='#334155' text-anchor='middle'>3</text><line x1='85' y1='25' x2='295' y2='25' stroke='#2563eb' stroke-width='3.5'/><line x1='85' y1='45' x2='85' y2='25' stroke='#2563eb' stroke-width='1.5' stroke-dasharray='2,2'/><line x1='295' y1='45' x2='295' y2='25' stroke='#2563eb' stroke-width='1.5' stroke-dasharray='2,2'/><circle cx='85' cy='25' r='5' fill='#ffffff' stroke='#2563eb' stroke-width='2'/><circle cx='295' cy='25' r='5.5' fill='#2563eb' stroke='#1d4ed8' stroke-width='1.5'/></svg>`.trim().replace(/\n\s*/g, '');

// 2. Vector SVG for Q17 & Q18: Isosceles Triangle with Base & Exterior Angles
const svgQ17Q18TriangleVar = `<svg viewBox='0 0 340 210' width='100%' height='170' xmlns='http://www.w3.org/2000/svg'><rect width='100%' height='100%' rx='6' fill='#f8fafc' stroke='#cbd5e1' stroke-width='1.5'/><line x1='30' y1='170' x2='310' y2='170' stroke='#1e293b' stroke-width='2'/><polygon points='90,170 180,35 270,170' fill='#eff6ff' stroke='#1e40af' stroke-width='2.5'/><line x1='130' y1='100' x2='140' y2='105' stroke='#1e293b' stroke-width='2'/><line x1='220' y1='105' x2='230' y2='100' stroke='#1e293b' stroke-width='2'/><path d='M 170 52 A 20 20 0 0 0 190 52' fill='none' stroke='#dc2626' stroke-width='1.8'/><text x='180' y='72' font-size='12' font-weight='bold' fill='#dc2626' text-anchor='middle'>y</text><path d='M 245 170 A 25 25 0 0 1 257 148' fill='none' stroke='#16a34a' stroke-width='1.8'/><text x='240' y='160' font-size='11' font-weight='bold' fill='#16a34a' text-anchor='end'>52°</text><path d='M 65 170 A 25 25 0 0 1 78 149' fill='none' stroke='#d97706' stroke-width='1.8'/><text x='65' y='145' font-size='12' font-weight='bold' fill='#d97706'>x</text><text x='180' y='200' font-size='10' font-weight='bold' fill='#64748b' text-anchor='middle'>NOT DRAWN TO SCALE</text></svg>`.trim().replace(/\n\s*/g, '');

// 3. Vector SVG for Q20 & Q21: Household Expenditure Pie Chart
const svgQ20Q21PieVar = `<svg viewBox='0 0 340 240' width='100%' height='210' xmlns='http://www.w3.org/2000/svg'><rect width='100%' height='100%' rx='6' fill='#f8fafc' stroke='#cbd5e1' stroke-width='1.5'/><g transform='translate(120, 115)'><path d='M 0 0 L 85 0 A 85 85 0 0 1 -26.27 80.84 Z' fill='#3b82f6' stroke='#ffffff' stroke-width='1.5'/><path d='M 0 0 L -26.27 80.84 A 85 85 0 0 1 -80.84 26.27 Z' fill='#64748b' stroke='#ffffff' stroke-width='1.5'/><path d='M 0 0 L -80.84 26.27 A 85 85 0 0 1 -85 0 Z' fill='#f59e0b' stroke='#ffffff' stroke-width='1.5'/><path d='M 0 0 L -85 0 A 85 85 0 0 1 -80.84 -26.27 Z' fill='#8b5cf6' stroke='#ffffff' stroke-width='1.5'/><path d='M 0 0 L -80.84 -26.27 A 85 85 0 0 1 -49.96 -68.77 Z' fill='#ec4899' stroke='#ffffff' stroke-width='1.5'/><path d='M 0 0 L -49.96 -68.77 A 85 85 0 0 1 26.27 -80.84 Z' fill='#06b6d4' stroke='#ffffff' stroke-width='1.5'/><path d='M 0 0 L 26.27 -80.84 A 85 85 0 0 1 85 0 Z' fill='#10b981' stroke='#ffffff' stroke-width='1.5'/></g><g transform='translate(215, 30)'><circle cx='10' cy='15' r='4.5' fill='#3b82f6'/><text x='20' y='18' font-size='9' font-weight='bold' fill='#334155'>Rent 30%</text><circle cx='10' cy='35' r='4.5' fill='#10b981'/><text x='20' y='38' font-size='9' font-weight='bold' fill='#334155'>Food 20%</text><circle cx='10' cy='55' r='4.5' fill='#06b6d4'/><text x='20' y='58' font-size='9' font-weight='bold' fill='#334155'>Insurance 15%</text><circle cx='10' cy='75' r='4.5' fill='#64748b'/><text x='20' y='78' font-size='9' font-weight='bold' fill='#334155'>Others 15%</text><circle cx='10' cy='95' r='4.5' fill='#ec4899'/><text x='20' y='98' font-size='9' font-weight='bold' fill='#334155'>Clothing 10%</text><circle cx='10' cy='115' r='4.5' fill='#8b5cf6'/><text x='20' y='118' font-size='9' font-weight='bold' fill='#334155'>Savings 5%</text><circle cx='10' cy='135' r='4.5' fill='#f59e0b'/><text x='20' y='138' font-size='9' font-weight='bold' fill='#334155'>Entertain. 5%</text></g><text x='170' y='230' font-size='10' font-weight='bold' fill='#64748b' text-anchor='middle'>NOT DRAWN TO SCALE</text></svg>`.trim().replace(/\n\s*/g, '');

// 4. Vector SVG for Q26: Quadratic Mapping
const svgQ26MappingVar = `<svg viewBox='0 0 320 110' width='100%' height='100' xmlns='http://www.w3.org/2000/svg'><rect width='100%' height='100%' rx='6' fill='#f8fafc' stroke='#cbd5e1' stroke-width='1.5'/><text x='35' y='38' font-size='14' font-style='italic' font-weight='bold' fill='#1e40af'>x</text><text x='35' y='88' font-size='14' font-style='italic' font-weight='bold' fill='#1e40af'>y</text><text x='85' y='38' font-size='13' font-weight='bold' fill='#0f172a' text-anchor='middle'>1</text><text x='145' y='38' font-size='13' font-weight='bold' fill='#0f172a' text-anchor='middle'>2</text><text x='205' y='38' font-size='13' font-weight='bold' fill='#0f172a' text-anchor='middle'>3</text><text x='265' y='38' font-size='13' font-weight='bold' fill='#0f172a' text-anchor='middle'>4</text><line x1='85' y1='48' x2='85' y2='70' stroke='#dc2626' stroke-width='1.8'/><polygon points='82,68 85,74 88,68' fill='#dc2626'/><line x1='145' y1='48' x2='145' y2='70' stroke='#dc2626' stroke-width='1.8'/><polygon points='142,68 145,74 148,68' fill='#dc2626'/><line x1='205' y1='48' x2='205' y2='70' stroke='#dc2626' stroke-width='1.8'/><polygon points='202,68 205,74 208,68' fill='#dc2626'/><line x1='265' y1='48' x2='265' y2='70' stroke='#dc2626' stroke-width='1.8'/><polygon points='262,68 265,74 268,68' fill='#dc2626'/><text x='85' y='90' font-size='13' font-weight='bold' fill='#0f172a' text-anchor='middle'>3</text><text x='145' y='90' font-size='13' font-weight='bold' fill='#0f172a' text-anchor='middle'>6</text><text x='205' y='90' font-size='13' font-weight='bold' fill='#0f172a' text-anchor='middle'>11</text><text x='265' y='90' font-size='13' font-weight='bold' fill='#0f172a' text-anchor='middle'>18</text></svg>`.trim().replace(/\n\s*/g, '');

// 5. Vector SVG for Q27: Right-angled Triangle MNO (6, 10, t)
const svgQ27RightTriangleVar = `<svg viewBox='0 0 320 190' width='100%' height='160' xmlns='http://www.w3.org/2000/svg'><rect width='100%' height='100%' rx='6' fill='#f8fafc' stroke='#cbd5e1' stroke-width='1.5'/><polygon points='60,35 60,150 250,150' fill='#eff6ff' stroke='#1e40af' stroke-width='2.5'/><rect x='60' y='136' width='14' height='14' fill='none' stroke='#475569' stroke-width='1.5'/><text x='50' y='30' font-size='12' font-weight='bold' fill='#0f172a'>M</text><text x='45' y='165' font-size='12' font-weight='bold' fill='#0f172a'>N</text><text x='258' y='160' font-size='12' font-weight='bold' fill='#0f172a'>O</text><text x='32' y='95' font-size='11' font-weight='bold' fill='#1e3a8a'>6 cm</text><text x='165' y='85' font-size='11' font-weight='bold' fill='#1e3a8a'>10 cm</text><text x='155' y='170' font-size='12' font-weight='bold' fill='#dc2626' text-anchor='middle'>t cm</text><text x='160' y='182' font-size='9' font-weight='bold' fill='#64748b' text-anchor='middle'>NOT DRAWN TO SCALE</text></svg>`.trim().replace(/\n\s*/g, '');
...
const paper1Questions = [
  ...
  },
  {
    ...
    "workedSolution": "$$CP = \\frac{88.00}{1.10} = \\text{GH¢ } 80.00$$.",
    "points": 1
  },
  {
    "number": 11,
  ...
  },
  {
    ...
    "workedSolution": "$$P = \\frac{100 \\times 360}{20 \\times 3} = \\frac{36000}{60} = \\text{GH¢ } 600.00$$.",
    "points": 1
  },
  {
    "number": 24,
  ...
  {
    "number": 27,
    "prompt": "Find the value of $t$ in the right-angled triangle below:<br/><svg viewBox='0 0 320 190' width='100%' height='160' xmlns='http://www.w3.org/2000/svg'><rect width='100%' height='100%' rx='6' fill='#f8fafc' stroke='#cbd5e1' stroke-width='1.5'/><polygon points='60,35 60,150 250,150' fill='#eff6ff' stroke='#1e40af' stroke-width='2.5'/><rect x='60' y='136' width='14' height='14' fill='none' stroke='#475569' stroke-width='1.5'/><text x='50' y='30' font-size='12' font-weight='bold' fill='#0f172a'>M</text><text x='45' y='165' font-size='12' font-weight='bold' fill='#0f172a'>N</text><text x='258' y='160' font-size='12' font-weight='bold' fill='#0f172a'>O</text><text x='32' y='95' font-size='11' font-weight='bold' fill='#1e3a8a'>6 cm</text><text x='165' y='85' font-size='11' font-weight='bold' fill='#1e3a8a'>10 cm</text><text x='155' y='170' font-size='12' font-weight='bold' fill='#dc2626' text-anchor='middle'>t cm</text><text x='160' y='182' font-size='9' font-weight='bold' fill='#64748b' text-anchor='middle'>NOT DRAWN TO SCALE</text></svg>",
    "options": [
      "8",
      "12",
      "6",
...
async function seedBece2020Paper1Variant() {
  console.log('Seeding 2020 BECE Paper 1 Variant (Set 60) into Firestore...');

  for (const q of paper1Questions) {
    q.options = shuffleArray(q.options);
  }

  const paperDocRef = db.doc('global_curriculum/jhs/subjects/math/past_papers/paper_2020_variant');
  ...
  console.log('✅ Successfully seeded all 40 questions of 2020 Paper 1 into past_papers/paper_2020_variant.');
}

seedBece2020Paper1Variant()
  .then(() => process.exit(0))
  .catch((err) => {
    console.error('Failed to seed 2020 Paper 1 variant:', err);
    process.exit(1);
  });
