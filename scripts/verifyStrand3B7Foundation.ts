...
async function verifyStrand3B7Foundation() {
  ...
  const subDocRef = db.doc(`global_curriculum/jhs/subjects/english/topical/${topicId}/practice_labs/B7_foundation`);
