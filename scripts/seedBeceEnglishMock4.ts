// Auto-generated BECE English Mock 4 Seed Script
// Primary doc: global_curriculum/jhs/subjects/english/mocks/mock_4
export const MOCK_4_PAYLOAD = {
  "mockId": "mock_4",
  "mockNumber": 4,
  ...
  "metadata": {
    ...
    "updatedAt": "2026-09-23T18:13:44.458Z"
  },
  "paper1": {
  ...
  "paper2": {
        ...
        "questions": [
          {
            ...
            "contextExtract": "\"Oliver looked through the window of the quiet country cottage. There, peering back at him through the glass with sinister, hateful eyes, stood Fagin and a tall, dark stranger with an evil scar across his throat.\"",
            "subItems": [
              {
                "subQuestion": "5(a)",
                "question": "Who was the 'tall, dark stranger' accompanying Fagin outside Oliver's window?",
                "answer": "Monks (Edward Leeford / Oliver Twist's criminal half-brother)."
              },
              {
                "subQuestion": "5(b)",
                "question": "Why was this tall, dark stranger desperately pursuing and trying to destroy young Oliver Twist?",
                "answer": "He wanted to corrupt Oliver, ruin his reputation, and secure Oliver's death or imprisonment in order to claim the entire family inheritance for himself."
              }
            ]
          },
          {
            "sectionTitle": "MERRILL CORNEY: Debbie, Sandy and Pepe",
            "contextExtract": "\"They placed soft green moss and cotton wool inside the shoe box. Pepe gave a faint chirp and opened his tiny beak for food.\"",
            "subItems": [
              {
                "subQuestion": "5(c)",
                "question": "What kind of creature was Pepe in the narrative?",
                "answer": "A wounded, helpless baby bird (a young chick / sparrow that fell from its nest)."
              },
              {
                "subQuestion": "5(d)",
                "question": "What positive moral virtue did the young girls demonstrate toward the helpless creature?",
                "answer": "Compassion, tender affection, kindness, and protective responsibility."
              }
            ]
          },
          {
            "sectionTitle": "KAAKYIRE AKOSOMO NYANTAKYI: The Generous Hunter",
            "contextExtract": "\"The hunter reached into his bag and spared the creature's life. 'Go in peace,' Asempa whispered. Later, in the dark forest, a voice spoke from the tall grass.\"",
            "subItems": [
              {
                "subQuestion": "5(e)",
                "question": "Who was the speaking creature that Asempa had shown mercy and kindness to?",
                "answer": "The mystical animal / snake (or the enchanted animal elder)."
              },
              {
                "subQuestion": "5(f)",
                "question": "How was Asempa's generosity rewarded at the conclusion of the story?",
                "answer": "He was shown a miraculous medicinal herb that cured the royal princess, earning him boundless wealth, respect, and honors."
              }
            ]
          },
          {
            ...
            "subItems": [
              {
                "subQuestion": "5(g)",
                "question": "Identify the dominant literary figure of speech in the expression: '... laughs the rose'.",
                "answer": "Personification."
              },
              {
                "subQuestion": "5(h)",
                "question": "What profound moral message does the poem convey regarding human racial prejudice and discrimination?",
                "answer": "Human obsession with skin color is foolish; God is universal, transcending physical racial divisions, and is embodied in love."
              }
            ]
          },
          {
            "sectionTitle": "LAWRENCE DARMANI: Scribbler's Dream",
            "contextExtract": "\"There is your quill and parchment,\nBut heavy are your hands.\nWhy?\nBecause disuse numbs the wrist.\"",
            "subItems": [
              {
                "subQuestion": "5(i)",
                "question": "What physical tools mentioned in the extract metaphorically represent the tools of the writer's craft?",
                "answer": "Quill and parchment (pen and paper / writing instruments)."
              },
              {
                "subQuestion": "5(j)",
                "question": "What warning does the poet give to aspiring creative writers in the line: 'Because disuse numbs the wrist'?",
                "answer": "Failing to practice and write regularly paralyzes one's creative talents and extinguishes creative potential."
              }
            ]
          }
        ]
    ...
    "questions": [
      ...
      },
      {
        ...
        "prompt": "Write an article for publication in your school magazine on the topic: \"The Impact of Artificial Intelligence and Modern Educational Software on Student Learning in Junior High Schools.\"",
        "markingScheme": "HARNESSING ARTIFICIAL INTELLIGENCE FOR EDUCATIONAL EXCELLENCE\nBy Samuel K. Boateng, Begoro\n\nThe twenty-first century is witnessing an extraordinary technological transformation driven by Artificial Intelligence (AI) and modern digital educational applications. In previous generations, basic school students relied exclusively on physical textbooks and teacher-delivered lectures. Today, the integration of interactive digital software into junior high education offers revolutionary opportunities to democratize learning and accelerate student comprehension.\n\nFirst and foremost, AI-powered learning applications provide personalized, self-paced academic tutoring. In a traditional basic classroom containing fifty or more pupils, teachers cannot possibly cater to the unique cognitive learning speed of every child. Digital educational platforms solve this handicap by automatically assessing a learner's strengths and weaknesses in subjects like Mathematics and Integrated Science. If a student struggles with algebraic equations, the software provides tailored step-by-step interactive drills, instant feedback, and visual diagrams until mastery is achieved. This individualized instruction builds student confidence and eliminates the fear of quantitative subjects.\n\nSecondly, digital educational tools make abstract scientific concepts vivid and accessible. Through virtual laboratory simulations, students can observe chemical reactions, explore internal cellular biology in three dimensions, and simulate planetary orbits without requiring expensive physical apparatus. This practical immersion stimulates inquisitive curiosity, sharpens analytical problem-solving skills, and prepares young minds for STEM careers.\n\nHowever, to prevent digital software from becoming a distraction, school authorities must guide students to use AI tools responsibly as intellectual tutors rather than shortcuts for plagiarizing homework assignments.\n\nArtificial Intelligence is not a replacement for human educators; it is a powerful catalyst that, when harnessed with discipline, unlocks boundless intellectual potential.",
        "sampleAnswer": "HARNESSING ARTIFICIAL INTELLIGENCE FOR EDUCATIONAL EXCELLENCE\nBy Samuel K. Boateng, Begoro\n\nThe twenty-first century is witnessing an extraordinary technological transformation driven by Artificial Intelligence (AI) and modern digital educational applications. In previous generations, basic school students relied exclusively on physical textbooks and teacher-delivered lectures. Today, the integration of interactive digital software into junior high education offers revolutionary opportunities to democratize learning and accelerate student comprehension.\n\nFirst and foremost, AI-powered learning applications provide personalized, self-paced academic tutoring. In a traditional basic classroom containing fifty or more pupils, teachers cannot possibly cater to the unique cognitive learning speed of every child. Digital educational platforms solve this handicap by automatically assessing a learner's strengths and weaknesses in subjects like Mathematics and Integrated Science. If a student struggles with algebraic equations, the software provides tailored step-by-step interactive drills, instant feedback, and visual diagrams until mastery is achieved. This individualized instruction builds student confidence and eliminates the fear of quantitative subjects.\n\nSecondly, digital educational tools make abstract scientific concepts vivid and accessible. Through virtual laboratory simulations, students can observe chemical reactions, explore internal cellular biology in three dimensions, and simulate planetary orbits without requiring expensive physical apparatus. This practical immersion stimulates inquisitive curiosity, sharpens analytical problem-solving skills, and prepares young minds for STEM careers.\n\nHowever, to prevent digital software from becoming a distraction, school authorities must guide students to use AI tools responsibly as intellectual tutors rather than shortcuts for plagiarizing homework assignments.\n\nArtificial Intelligence is not a replacement for human educators; it is a powerful catalyst that, when harnessed with discipline, unlocks boundless intellectual potential.",
        "workedSolution": "HARNESSING ARTIFICIAL INTELLIGENCE FOR EDUCATIONAL EXCELLENCE\nBy Samuel K. Boateng, Begoro\n\nThe twenty-first century is witnessing an extraordinary technological transformation driven by Artificial Intelligence (AI) and modern digital educational applications. In previous generations, basic school students relied exclusively on physical textbooks and teacher-delivered lectures. Today, the integration of interactive digital software into junior high education offers revolutionary opportunities to democratize learning and accelerate student comprehension.\n\nFirst and foremost, AI-powered learning applications provide personalized, self-paced academic tutoring. In a traditional basic classroom containing fifty or more pupils, teachers cannot possibly cater to the unique cognitive learning speed of every child. Digital educational platforms solve this handicap by automatically assessing a learner's strengths and weaknesses in subjects like Mathematics and Integrated Science. If a student struggles with algebraic equations, the software provides tailored step-by-step interactive drills, instant feedback, and visual diagrams until mastery is achieved. This individualized instruction builds student confidence and eliminates the fear of quantitative subjects.\n\nSecondly, digital educational tools make abstract scientific concepts vivid and accessible. Through virtual laboratory simulations, students can observe chemical reactions, explore internal cellular biology in three dimensions, and simulate planetary orbits without requiring expensive physical apparatus. This practical immersion stimulates inquisitive curiosity, sharpens analytical problem-solving skills, and prepares young minds for STEM careers.\n\nHowever, to prevent digital software from becoming a distraction, school authorities must guide students to use AI tools responsibly as intellectual tutors rather than shortcuts for plagiarizing homework assignments.\n\nArtificial Intelligence is not a replacement for human educators; it is a powerful catalyst that, when harnessed with discipline, unlocks boundless intellectual potential.",
        "points": 30
      },
      {
        "number": 3,
        ...
        "prompt": "Write an engaging, realistic story that illustrates the traditional proverb: \"Pride goes before a fall.\"",
        "markingScheme": "PRIDE GOES BEFORE A FALL\n\nIn our basic school, my classmate, Richmond, was blessed with exceptional academic brilliance and athletic speed. He topped our class in all subjects and anchored our school relay team to multiple regional victories. However, Richmond's outstanding talents were completely overshadowed by his unbearable pride, arrogance, and contempt for others.\n\nHe strutted around the compound boasting that he was an invincible genius who did not require revision or teacher guidance. He mocked struggling classmates, ridiculed our hardworking teachers' chalkboard notes, and refused to participate in morning preparatory studies, scoffing arrogantly: \"Examinations are for ordinary minds; champions like me pass without breaking a sweat!\" Our wise class tutor, Master Asiedu, continually warned him that \"pride goes before a fall,\" but Richmond dismissed the counsel with disdain.\n\nThe day of reckoning arrived during the Annual Inter-District Academic and Track Championships. Overconfident and arrogant, Richmond spent the night before the event playing video games on his phone, skipping dinner, and drinking ice water. When he arrived at the stadium, he refused to warm up with the squad, openly sneering at his competitors.\n\nDuring the final 400-meter sprint, the starting pistol sounded. Richmond surged ahead, looking back mockingly to laugh at his pursuers. Suddenly, fifty meters from the finish line, violent muscle cramps seized his dehydrated legs. His knees buckled, and he collapsed headlong onto the cinder track with a sickening thud, groaning in agony as his humble competitors sprinted past him to the finish line.\n\nCarried off the track on a stretcher amidst the pitying glances of onlookers, Richmond wept bitter tears of humiliation. His arrogance had cost him the national trophy. Sitting quietly by his dispensary bed, the ancient truth resonated in my heart: Truly, pride goes before a fall.",
        "sampleAnswer": "PRIDE GOES BEFORE A FALL\n\nIn our basic school, my classmate, Richmond, was blessed with exceptional academic brilliance and athletic speed. He topped our class in all subjects and anchored our school relay team to multiple regional victories. However, Richmond's outstanding talents were completely overshadowed by his unbearable pride, arrogance, and contempt for others.\n\nHe strutted around the compound boasting that he was an invincible genius who did not require revision or teacher guidance. He mocked struggling classmates, ridiculed our hardworking teachers' chalkboard notes, and refused to participate in morning preparatory studies, scoffing arrogantly: \"Examinations are for ordinary minds; champions like me pass without breaking a sweat!\" Our wise class tutor, Master Asiedu, continually warned him that \"pride goes before a fall,\" but Richmond dismissed the counsel with disdain.\n\nThe day of reckoning arrived during the Annual Inter-District Academic and Track Championships. Overconfident and arrogant, Richmond spent the night before the event playing video games on his phone, skipping dinner, and drinking ice water. When he arrived at the stadium, he refused to warm up with the squad, openly sneering at his competitors.\n\nDuring the final 400-meter sprint, the starting pistol sounded. Richmond surged ahead, looking back mockingly to laugh at his pursuers. Suddenly, fifty meters from the finish line, violent muscle cramps seized his dehydrated legs. His knees buckled, and he collapsed headlong onto the cinder track with a sickening thud, groaning in agony as his humble competitors sprinted past him to the finish line.\n\nCarried off the track on a stretcher amidst the pitying glances of onlookers, Richmond wept bitter tears of humiliation. His arrogance had cost him the national trophy. Sitting quietly by his dispensary bed, the ancient truth resonated in my heart: Truly, pride goes before a fall.",
        "workedSolution": "PRIDE GOES BEFORE A FALL\n\nIn our basic school, my classmate, Richmond, was blessed with exceptional academic brilliance and athletic speed. He topped our class in all subjects and anchored our school relay team to multiple regional victories. However, Richmond's outstanding talents were completely overshadowed by his unbearable pride, arrogance, and contempt for others.\n\nHe strutted around the compound boasting that he was an invincible genius who did not require revision or teacher guidance. He mocked struggling classmates, ridiculed our hardworking teachers' chalkboard notes, and refused to participate in morning preparatory studies, scoffing arrogantly: \"Examinations are for ordinary minds; champions like me pass without breaking a sweat!\" Our wise class tutor, Master Asiedu, continually warned him that \"pride goes before a fall,\" but Richmond dismissed the counsel with disdain.\n\nThe day of reckoning arrived during the Annual Inter-District Academic and Track Championships. Overconfident and arrogant, Richmond spent the night before the event playing video games on his phone, skipping dinner, and drinking ice water. When he arrived at the stadium, he refused to warm up with the squad, openly sneering at his competitors.\n\nDuring the final 400-meter sprint, the starting pistol sounded. Richmond surged ahead, looking back mockingly to laugh at his pursuers. Suddenly, fifty meters from the finish line, violent muscle cramps seized his dehydrated legs. His knees buckled, and he collapsed headlong onto the cinder track with a sickening thud, groaning in agony as his humble competitors sprinted past him to the finish line.\n\nCarried off the track on a stretcher amidst the pitying glances of onlookers, Richmond wept bitter tears of humiliation. His arrogance had cost him the national trophy. Sitting quietly by his dispensary bed, the ancient truth resonated in my heart: Truly, pride goes before a fall.",
        "points": 30
      },
      {
        "number": 4,
      ...
      },
      {
        ...
        "prompt": "Text: CHARLES DICKENS: Oliver Twist\nExtract: \"Oliver looked through the window of the quiet country cottage. There, peering back at him through the glass with sinister, hateful eyes, stood Fagin and a tall, dark stranger with an evil scar across his throat.\"\n\n5(a) Who was the 'tall, dark stranger' accompanying Fagin outside Oliver's window?\n5(b) Why was this tall, dark stranger desperately pursuing and trying to destroy young Oliver Twist?",
        "contextExtract": "\"Oliver looked through the window of the quiet country cottage. There, peering back at him through the glass with sinister, hateful eyes, stood Fagin and a tall, dark stranger with an evil scar across his throat.\"",
        "subQuestions": [
          {
            "label": "5(a)",
        ...
        "markingScheme": "5(a) Who was the 'tall, dark stranger' accompanying Fagin outside Oliver's window?\nAnswer: Monks (Edward Leeford / Oliver Twist's criminal half-brother).\n\n5(b) Why was this tall, dark stranger desperately pursuing and trying to destroy young Oliver Twist?\nAnswer: He wanted to corrupt Oliver, ruin his reputation, and secure Oliver's death or imprisonment in order to claim the entire family inheritance for himself.",
        "workedSolution": "5(a) Who was the 'tall, dark stranger' accompanying Fagin outside Oliver's window?\nAnswer: Monks (Edward Leeford / Oliver Twist's criminal half-brother).\n\n5(b) Why was this tall, dark stranger desperately pursuing and trying to destroy young Oliver Twist?\nAnswer: He wanted to corrupt Oliver, ruin his reputation, and secure Oliver's death or imprisonment in order to claim the entire family inheritance for himself.",
        "points": 10
      },
      {
        "number": 6,
        "part": "Part C",
        "title": "Question 5(b): MERRILL CORNEY: Debbie, Sandy and Pepe",
        "prompt": "Text: MERRILL CORNEY: Debbie, Sandy and Pepe\nExtract: \"They placed soft green moss and cotton wool inside the shoe box. Pepe gave a faint chirp and opened his tiny beak for food.\"\n\n5(c) What kind of creature was Pepe in the narrative?\n5(d) What positive moral virtue did the young girls demonstrate toward the helpless creature?",
        "contextExtract": "\"They placed soft green moss and cotton wool inside the shoe box. Pepe gave a faint chirp and opened his tiny beak for food.\"",
        "subQuestions": [
          {
            "label": "5(c)",
        ...
        "markingScheme": "5(c) What kind of creature was Pepe in the narrative?\nAnswer: A wounded, helpless baby bird (a young chick / sparrow that fell from its nest).\n\n5(d) What positive moral virtue did the young girls demonstrate toward the helpless creature?\nAnswer: Compassion, tender affection, kindness, and protective responsibility.",
        "workedSolution": "5(c) What kind of creature was Pepe in the narrative?\nAnswer: A wounded, helpless baby bird (a young chick / sparrow that fell from its nest).\n\n5(d) What positive moral virtue did the young girls demonstrate toward the helpless creature?\nAnswer: Compassion, tender affection, kindness, and protective responsibility.",
        "points": 10
      },
      {
        "number": 7,
        "part": "Part C",
        "title": "Question 5(c): KAAKYIRE AKOSOMO NYANTAKYI: The Generous Hunter",
        "prompt": "Text: KAAKYIRE AKOSOMO NYANTAKYI: The Generous Hunter\nExtract: \"The hunter reached into his bag and spared the creature's life. 'Go in peace,' Asempa whispered. Later, in the dark forest, a voice spoke from the tall grass.\"\n\n5(e) Who was the speaking creature that Asempa had shown mercy and kindness to?\n5(f) How was Asempa's generosity rewarded at the conclusion of the story?",
        "contextExtract": "\"The hunter reached into his bag and spared the creature's life. 'Go in peace,' Asempa whispered. Later, in the dark forest, a voice spoke from the tall grass.\"",
        "subQuestions": [
          {
            "label": "5(e)",
        ...
        "markingScheme": "5(e) Who was the speaking creature that Asempa had shown mercy and kindness to?\nAnswer: The mystical animal / snake (or the enchanted animal elder).\n\n5(f) How was Asempa's generosity rewarded at the conclusion of the story?\nAnswer: He was shown a miraculous medicinal herb that cured the royal princess, earning him boundless wealth, respect, and honors.",
        "workedSolution": "5(e) Who was the speaking creature that Asempa had shown mercy and kindness to?\nAnswer: The mystical animal / snake (or the enchanted animal elder).\n\n5(f) How was Asempa's generosity rewarded at the conclusion of the story?\nAnswer: He was shown a miraculous medicinal herb that cured the royal princess, earning him boundless wealth, respect, and honors.",
        "points": 10
      },
      {
        "number": 8,
        "part": "Part C",
        "title": "Question 5(d): V. B. AAKYE: The Colour of God",
        "prompt": "Text: V. B. AAKYE: The Colour of God\nExtract: \"How silly man is, laughs the rose\nWhy should he be black or white\nOr green or yellow or even red?\"\n\n5(g) Identify the dominant literary figure of speech in the expression: '... laughs the rose'.\n5(h) What profound moral message does the poem convey regarding human racial prejudice and discrimination?",
        "contextExtract": "\"How silly man is, laughs the rose\nWhy should he be black or white\nOr green or yellow or even red?\"",
        "subQuestions": [
          {
            "label": "5(g)",
        ...
        "markingScheme": "5(g) Identify the dominant literary figure of speech in the expression: '... laughs the rose'.\nAnswer: Personification.\n\n5(h) What profound moral message does the poem convey regarding human racial prejudice and discrimination?\nAnswer: Human obsession with skin color is foolish; God is universal, transcending physical racial divisions, and is embodied in love.",
        "workedSolution": "5(g) Identify the dominant literary figure of speech in the expression: '... laughs the rose'.\nAnswer: Personification.\n\n5(h) What profound moral message does the poem convey regarding human racial prejudice and discrimination?\nAnswer: Human obsession with skin color is foolish; God is universal, transcending physical racial divisions, and is embodied in love.",
        "points": 10
      },
      {
        "number": 9,
        "part": "Part C",
        "title": "Question 5(e): LAWRENCE DARMANI: Scribbler's Dream",
        "prompt": "Text: LAWRENCE DARMANI: Scribbler's Dream\nExtract: \"There is your quill and parchment,\nBut heavy are your hands.\nWhy?\nBecause disuse numbs the wrist.\"\n\n5(i) What physical tools mentioned in the extract metaphorically represent the tools of the writer's craft?\n5(j) What warning does the poet give to aspiring creative writers in the line: 'Because disuse numbs the wrist'?",
        "contextExtract": "\"There is your quill and parchment,\nBut heavy are your hands.\nWhy?\nBecause disuse numbs the wrist.\"",
        "subQuestions": [
          {
            "label": "5(i)",
        ...
        "markingScheme": "5(i) What physical tools mentioned in the extract metaphorically represent the tools of the writer's craft?\nAnswer: Quill and parchment (pen and paper / writing instruments).\n\n5(j) What warning does the poet give to aspiring creative writers in the line: 'Because disuse numbs the wrist'?\nAnswer: Failing to practice and write regularly paralyzes one's creative talents and extinguishes creative potential.",
        "workedSolution": "5(i) What physical tools mentioned in the extract metaphorically represent the tools of the writer's craft?\nAnswer: Quill and parchment (pen and paper / writing instruments).\n\n5(j) What warning does the poet give to aspiring creative writers in the line: 'Because disuse numbs the wrist'?\nAnswer: Failing to practice and write regularly paralyzes one's creative talents and extinguishes creative potential.",
        "points": 10
      }
    ]
  }
