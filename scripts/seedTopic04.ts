...
async function seed() {
  const filePath = path.join(__dirname, 'payloads', 'topic_ratio_proportion_financial.json');
  ...
  console.log(`\n================================================================`);
  console.log(`🚀 SEEDING TOPIC 04: "${payload.title}" [ID: ${payload.id}]`);
  console.log(`================================================================`);
  ...
  // Also maintain alias documents for legacy routes
  ...
  console.log(`🔄 Synced alias documents: topic_ratios_and_proportion, topic_ratio_and_proportion`);
}
