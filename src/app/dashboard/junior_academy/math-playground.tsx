    ...
    return (
        <div className="w-full bg-white p-12 rounded-[4rem] shadow-2xl border-8 border-orange-100 flex flex-col items-center min-h-[600px]">
            ...
            <div className="flex flex-wrap justify-center gap-3">
             ...
             {userAnswer === (current.val1 + current.val2) && <Button onClick={() => setIndex((index + 1) % data.length)} className="mt-12 bg-green-500 text-white rounded-2xl px-10 h-14">NEXT PROBLEM</Button>}
        </div>
    );
};
