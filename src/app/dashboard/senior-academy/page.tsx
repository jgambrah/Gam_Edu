    ...
    },
{
    ...
    },
    {
        ...
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Official isomorphic practice variant of the 2013 BECE Integrated Science Paper 1. Contains 40 balanced objective questions with responsive vector lever/expansion SVGs, diagnostic hints, and full step-by-step solutions.",
        difficulty: "Intermediate",
        kind: "exam_series",
    ...
    },
    {
        ...
        gradeTier: "Junior Secondary (JHS)",
        meta: "Section A + Section B • 75 mins • 100 Marks",
        description: "Standardized practical and theory essay examination variant featuring Section A compulsory laboratory tests (living tuber cavity osmosis, zinc displacement reaction, vacuum thermos flask thermodynamic anatomy, comparative soil drainage) and Section B theory essays.",
        difficulty: "Advanced",
        kind: "exam_series",
...
function findModuleForExam(modules: SuggestedModuleCard[], examId?: string, paperType?: string | number): SuggestedModuleCard | null {
    ...
    const catalogMap: Record<string, { setNum: number; paper?: number; year?: number }> = {
        ...
        'paper_2013_variant': { setNum: 90, paper: 1, year: 2013 },
        'paper_2013_variant_p2': { setNum: 91, paper: 2, year: 2013 },
