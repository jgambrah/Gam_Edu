...
import { SET_BECE_MOCK_6_SCIENCE_P1, SET_BECE_MOCK_6_SCIENCE_P2 } from '@/lib/data/jhs-curriculum-set-137';
import { SET_BECE_MOCK_7_SCIENCE_P1, SET_BECE_MOCK_7_SCIENCE_P2 } from '@/lib/data/jhs-curriculum-set-138';
import { SET_BECE_MOCK_8_SCIENCE_P1, SET_BECE_MOCK_8_SCIENCE_P2 } from '@/lib/data/jhs-curriculum-set-139';
...
const SUGGESTED_MATH_MODULES: SuggestedModuleCard[] = [
    ...
    },
    {
        ...
        description: "Curriculum-aligned SHS core mathematics examination series model covering differential calculus, polynomials, matrices, and vectors.",
        difficulty: "Advanced",
    ...
    // Junior Secondary (JHS) Exam Series (Standardized Past Papers & Mastery Sets)
    {
        ...
        meta: "40 Questions • 60 mins • Curriculum-Aligned Model",
        description: "Curriculum-calibrated 40-question objective model featuring number bases, plane geometry, algebraic expressions, and step-by-step verified solutions.",
        difficulty: "Advanced",
    ...
    },
    {
        ...
        domain: "ALGEBRA",
        gradeTier: "Junior Secondary (JHS)",
        meta: "6 Multi-Part Problems • 60 mins • Structured Theory",
        description: "Comprehensive multi-part mathematical modeling and structured problem-solving modules with complete analytical derivations and marking rubrics.",
        difficulty: "Advanced",
        topicId: "core_curriculum_mastery",
    ...
    },
    {
        ...
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 60 mins • Curriculum-Aligned Model",
        description: "Standardized 40-question objective assessment calibrated to the 2011 syllabus framework, covering prime factorization, base-two operations, sets, and coordinate vectors.",
        difficulty: "Advanced",
        topicId: "core_curriculum_mastery",
    ...
    },
    {
        ...
        gradeTier: "Junior Secondary (JHS)",
        meta: "6 Multi-Part Problems • 60 mins • Structured Theory",
        description: "Standardized 6-question structured theory assessment featuring interactive SVG geometry diagrams, coordinate transformations, algebraic fractions, and frequency distributions.",
        difficulty: "Advanced",
        topicId: "core_curriculum_mastery",
    ...
    },
    {
        ...
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 60 mins • Curriculum-Aligned Model",
        description: "Standardized 40-question objective assessment calibrated to the 2010 curriculum, covering sets, base-five sequences, inverse proportion, and probability.",
        difficulty: "Advanced",
        topicId: "core_curriculum_mastery",
    ...
    },
    {
        ...
        gradeTier: "Junior Secondary (JHS)",
        meta: "6 Multi-Part Problems • 60 mins • Structured Theory",
        description: "Standardized 6-question structured theory examination featuring embedded SVG diagrams for Venn partitions, composite solids, liquid volume conversions, and statistics.",
        difficulty: "Advanced",
        topicId: "core_curriculum_mastery",
...
const SUGGESTED_ENGLISH_MODULES: SuggestedModuleCard[] = [
    ...
    },
    {
        ...
        strandName: "Strand 3: Grammar & Usage",
        strandCode: "B7-B9.3",
        subStrand: "2018 BECE English Language Objective Assessment",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Standardized CBT",
        description: "Official 40-question objective assessment covering Lexis and Structure, Synonyms, Antonyms, Idioms, Cloze Test, and Oral Language.",
        difficulty: "Advanced",
    ...
    },
    {
        ...
        strandName: "Strand 4: Writing",
        strandCode: "B7-B9.4",
        subStrand: "2018 BECE Written Essay, Comprehension & Literature",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Part A, B & C • 75 mins • Standardized Essay",
        description: "Standardized 3-part essay, reading comprehension, and The Cockcrow literature examination with authentic Ghanaian marking guides.",
        difficulty: "Advanced",
    ...
    },
    {
        ...
        strandName: "Strand 3: Grammar & Usage",
        strandCode: "B7-B9.3",
        subStrand: "2017 BECE English Language Objective Assessment",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Standardized CBT",
        description: "Official 40-question objective assessment covering Lexis and Structure, Synonyms, Antonyms, Idioms, Cloze Test, and Oral Language.",
        difficulty: "Advanced",
    ...
    },
    {
        ...
        strandName: "Strand 4: Writing",
        strandCode: "B7-B9.4",
        subStrand: "2017 BECE Written Essay, Comprehension & Literature",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Part A, B & C • 75 mins • Standardized Essay",
        description: "Standardized 3-part essay, reading comprehension, and The Cockcrow literature examination with authentic Ghanaian marking guides.",
        difficulty: "Advanced",
    ...
    },
    {
        ...
        strandCode: "B7-B9.2",
        subStrand: "2016 BECE Standardized Objective Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Standardized CBT",
        description: "Official 40-question objective assessment covering Lexis and Structure, Synonyms, Antonyms, Idioms, Cloze Test, and Oral Language.",
        difficulty: "Advanced",
    ...
    },
    {
        ...
        strandName: "Strand 4: Writing",
        strandCode: "B7-B9.4",
        subStrand: "2016 BECE Written Essay, Comprehension & Literature",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Part A, B & C • 75 mins • Standardized Essay",
        description: "Standardized 3-part essay, reading comprehension on environmental degradation, and The Cockcrow literature examination with authentic Ghanaian marking guides.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "bece_2016_p2",
        topicId: "past_questions",
    ...
    },
    {
        ...
        strandName: "Strand 2: Grammar & Lexis",
        strandCode: "B7-B9.2",
        subStrand: "2015 BECE Standardized Objective Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Standardized CBT",
        description: "Official 40-question objective assessment covering Lexis and Structure, Synonyms, Antonyms, Idioms, and Literature in English.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "bece_2015_p1",
        topicId: "past_questions",
    ...
    },
    {
        ...
        strandName: "Strand 4: Writing",
        strandCode: "B7-B9.4",
        subStrand: "2015 BECE Written Essay & Reading Comprehension",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Part A & B • 75 mins • Standardized Essay",
        description: "Standardized 2-part essay and reading comprehension on drought and community solidarity with authentic Ghanaian marking guides.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "bece_2015_p2",
        topicId: "past_questions",
        ...
        era: "modern",
        questionCount: 2,
        examTag: "Essay & Comprehension • Authentic Ghanaian Marking Guide",
        subject: "English Language",
        status: "ready"
    },
    {
        ...
        strandName: "Strand 2: Grammar & Lexis",
        strandCode: "B7-B9.2",
        subStrand: "2014 BECE Standardized Objective Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Standardized CBT",
        description: "Official 40-question objective assessment covering Lexis and Structure, Synonyms, Antonyms, Idioms, and Literature in English.",
        difficulty: "Advanced",
    ...
    },
    {
        ...
        strandName: "Strand 4: Writing",
        strandCode: "B7-B9.4",
        subStrand: "2014 BECE Written Essay & Reading Comprehension",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Part A & B • 75 mins • Standardized Essay",
        description: "Standardized 2-part essay and reading comprehension on pastoral traditions, domestic life, and societal customs with authentic Ghanaian marking guides.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "bece_2014_p2",
        topicId: "past_questions",
    ...
    },
    {
        ...
        strandName: "Strand 2: Grammar & Lexis",
        strandCode: "B7-B9.2",
        subStrand: "2013 BECE Standardized Objective Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Standardized CBT",
        description: "Official 40-question objective assessment covering Lexis and Structure, Synonyms, Antonyms, Idioms, and Literature in English.",
        difficulty: "Advanced",
    ...
    },
    {
        ...
        strandName: "Strand 4: Writing",
        strandCode: "B7-B9.4",
        subStrand: "2013 BECE Written Essay & Reading Comprehension",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Part A & B • 75 mins • Standardized Essay",
        description: "Standardized 2-part essay and reading comprehension on Ghanaian folklore (Kweku Ananse and the boiling water ordeal) with authentic Ghanaian marking guides.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "bece_2013_p2",
        topicId: "past_questions",
    ...
    },
    {
        ...
        strandName: "Strand 2: Grammar & Lexis",
        strandCode: "B7-B9.2",
        subStrand: "2012 BECE Standardized Objective Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Standardized CBT",
        description: "Official 40-question objective assessment covering Lexis and Structure, Synonyms, Antonyms, Idioms, and Literature in English.",
        difficulty: "Advanced",
    ...
    },
    {
        ...
        strandName: "Strand 4: Writing",
        strandCode: "B7-B9.4",
        subStrand: "2012 BECE Written Essay & Reading Comprehension",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Part A & B • 75 mins • Standardized Essay",
        description: "Standardized 2-part essay and reading comprehension on public health (epidemiology of cholera) with authentic Ghanaian marking guides.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "bece_2012_p2",
        topicId: "past_questions",
    ...
    },
    {
        ...
        strandName: "Strand 2: Grammar & Lexis",
        strandCode: "B7-B9.2",
        subStrand: "2011 BECE Standardized Objective Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Standardized CBT",
        description: "Official 40-question objective assessment covering Lexis and Structure, Synonyms, Antonyms, Idioms, and Literature in English.",
        difficulty: "Advanced",
    ...
    },
    {
        ...
        strandName: "Strand 4: Writing",
        strandCode: "B7-B9.4",
        subStrand: "2011 BECE Written Essay & Reading Comprehension",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Part A & B • 75 mins • Standardized Essay",
        description: "Standardized 2-part essay and reading comprehension on hard work versus reliance on luck with authentic Ghanaian marking guides.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "bece_2011_p2",
        topicId: "past_questions",
    ...
    },
    {
        ...
        strandName: "Strand 2: Grammar & Lexis",
        strandCode: "B7-B9.2",
        subStrand: "2010 BECE Standardized Objective Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Standardized CBT",
        description: "Official 40-question objective assessment covering Lexis and Structure, Synonyms, Antonyms, Idioms, and Literature in English.",
        difficulty: "Advanced",
    ...
    },
    {
        ...
        strandName: "Strand 4: Writing",
        strandCode: "B7-B9.4",
        subStrand: "2010 BECE Written Essay & Reading Comprehension",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Part A & B • 75 mins • Standardized Essay",
        description: "Standardized 2-part essay and reading comprehension on childhood hyperactivity, errands, and domestic discipline with authentic Ghanaian marking guides.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "bece_2010_p2",
        topicId: "past_questions",
    ...
    },
    {
        ...
        strandName: "Strand 2: Grammar & Lexis",
        strandCode: "B7-B9.2",
        subStrand: "2009 BECE Standardized Objective Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Standardized CBT",
        description: "Official 40-question objective assessment covering Reading Comprehension, Synonyms, Antonyms, Idioms, and Lexis and Structure.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "bece_2009_p1",
        topicId: "past_questions",
    ...
    },
    {
        ...
        strandName: "Strand 4: Writing",
        strandCode: "B7-B9.4",
        subStrand: "2009 BECE Written Essay Composition",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Part A • 75 mins • Standardized Essay",
        description: "Standardized 4-prompt essay writing covering letters, debates, and formal reports with authentic Ghanaian pedagogical model answers.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "bece_2009_p2",
        topicId: "past_questions",
    ...
    },
    {
        ...
        strandName: "Strand 2: Grammar & Lexis",
        strandCode: "B7-B9.2",
        subStrand: "2008 BECE Standardized Objective Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Standardized CBT",
        description: "Official 40-question objective assessment covering Reading Comprehension, Synonyms, Antonyms, Idioms, and Lexis and Structure.",
        difficulty: "Advanced",
    ...
    },
    {
        ...
        strandName: "Strand 4: Writing",
        strandCode: "B7-B9.4",
        subStrand: "2008 BECE Written Essay Composition",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Part A • 75 mins • Standardized Essay",
        description: "Standardized 4-prompt essay writing covering informal letters, PTA appeals, orientation addresses, and moral narratives with authentic Ghanaian model answers.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "bece_2008_p2",
        topicId: "past_questions",
    ...
    },
    {
        ...
        strandName: "Strand 2: Grammar & Lexis",
        strandCode: "B7-B9.2",
        subStrand: "2007 BECE Standardized Objective Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Standardized CBT",
        description: "Official 40-question objective assessment covering Reading Comprehension, Synonyms, Antonyms, Idioms, and Lexis and Structure.",
        difficulty: "Advanced",
    ...
    },
    {
        ...
        strandName: "Strand 4: Writing",
        strandCode: "B7-B9.4",
        subStrand: "2007 BECE Written Essay Composition",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Part A • 75 mins • Standardized Essay",
        description: "Standardized 4-prompt essay writing covering pen-friend letters, water crisis petitions, Speech Day valedictories, and expository essays on Oware.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "bece_2007_p2",
        topicId: "past_questions",
    ...
    },
    {
        ...
        strandName: "Strand 2: Grammar & Lexis",
        strandCode: "B7-B9.2",
        subStrand: "2006 BECE Standardized Objective Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Standardized CBT",
        description: "Official 40-question objective assessment covering Reading Comprehension, Synonyms, Antonyms, Idioms, and Lexis and Structure.",
        difficulty: "Advanced",
    ...
    },
    {
        ...
        strandName: "Strand 4: Writing",
        strandCode: "B7-B9.4",
        subStrand: "2006 BECE Written Essay Composition",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Part A • 75 mins • Standardized Essay",
        description: "Standardized 4-prompt essay writing covering sanitation letters, family update letters, television debate speeches, and teacher award nominations.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "bece_2006_p2",
        topicId: "past_questions",
    ...
    },
    {
        ...
        strandName: "Strand 2: Grammar & Lexis",
        strandCode: "B7-B9.2",
        subStrand: "2005 BECE Standardized Objective Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Standardized CBT",
        description: "Official 40-question objective assessment covering Reading Comprehension, Synonyms, Antonyms, Idioms, and Lexis and Structure.",
        difficulty: "Advanced",
    ...
    },
    {
        ...
        strandName: "Strand 4: Writing",
        strandCode: "B7-B9.4",
        subStrand: "2005 BECE Written Essay Composition",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Part A • 75 mins • Standardized Essay",
        description: "Standardized 4-prompt essay writing covering mother request letters, messenger application letters, directional guides, and dispute narratives.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "bece_2005_p2",
        topicId: "past_questions",
    ...
    },
    {
        ...
        strandName: "Strand 2: Grammar & Lexis",
        strandCode: "B7-B9.2",
        subStrand: "2004 BECE Standardized Objective Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Standardized CBT",
        description: "Official 40-question objective assessment covering Reading Comprehension, Synonyms, Antonyms, Idioms, and Lexis and Structure.",
        difficulty: "Advanced",
    ...
    },
    {
        ...
        strandName: "Strand 4: Writing",
        strandCode: "B7-B9.4",
        subStrand: "2004 BECE Written Essay Composition",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Part A • 75 mins • Standardized Essay",
        description: "Standardized 4-prompt essay writing covering SHS admission letters, festival accounts, subject selection debate speeches, and Kejetia honesty narratives.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "bece_2004_p2",
        topicId: "past_questions",
    ...
    },
    {
        ...
        strandName: "Strand 2: Grammar & Lexis",
        strandCode: "B7-B9.2",
        subStrand: "2003 BECE Standardized Objective Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Standardized CBT",
        description: "Official 40-question objective assessment covering Reading Comprehension, Synonyms, Antonyms, Idioms, and Lexis and Structure.",
        difficulty: "Advanced",
    ...
    },
    {
        ...
        strandName: "Strand 4: Writing",
        strandCode: "B7-B9.4",
        subStrand: "2003 BECE Written Essay Composition",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Part A • 75 mins • Standardized Essay",
        description: "Standardized 4-prompt essay writing covering appeals to DCE for playing field development, family sponsorship requests, Akosombo excursion preparations, and Junior Graphic malpractice warnings.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "bece_2003_p2",
        topicId: "past_questions",
    ...
    },
    {
        ...
        strandName: "Strand 2: Grammar & Lexis",
        strandCode: "B7-B9.2",
        subStrand: "2001 BECE Standardized Objective Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Standardized CBT",
        description: "Official 40-question objective assessment covering Reading Comprehension, Synonyms, Antonyms, Idioms, and Lexis and Structure.",
        difficulty: "Advanced",
    ...
    },
    {
        ...
        strandName: "Strand 4: Writing",
        strandCode: "B7-B9.4",
        subStrand: "2001 BECE Written Essay Composition",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Part A • 75 mins • Standardized Essay",
        description: "Standardized 4-prompt essay writing covering pen-pal pride in school, headteacher petitions on teacher unprofessionalism, boys kitchen chores debates, and midnight fire rescue narratives.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "bece_2001_p2",
        topicId: "past_questions",
    ...
    },
    {
        ...
        strandName: "Strand 2: Grammar & Lexis",
        strandCode: "B7-B9.2",
        subStrand: "2000 BECE Standardized Objective Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Standardized CBT",
        description: "Official 40-question objective assessment covering Reading Comprehension, Synonyms, Antonyms, Idioms, and Lexis and Structure.",
        difficulty: "Advanced",
    ...
    },
    {
        ...
        strandName: "Strand 4: Writing",
        strandCode: "B7-B9.4",
        subStrand: "2000 BECE Written Essay Composition",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Part A • 75 mins • Standardized Essay",
        description: "Standardized 4-prompt essay writing covering sanitation petitions to Town Development Chairman, Mampong vacation invitations, Ananse moral folktales, and PTA senior prefect speeches.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "bece_2000_p2",
        topicId: "past_questions",
...
const SUGGESTED_SCIENCE_MODULES: SuggestedModuleCard[] = [
    ...
    },
    {
        ...
        strandCode: "S1-S5",
        subStrand: "2024 BECE Integrated Science Blueprint & Standardized CBT",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Objective Test",
        description: "Standardized 40-question objective examination variant with balanced key distribution (10 A, 10 B, 10 C, 10 D), KaTeX equations, diagnostic hints, and step-by-step worked solutions.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2024_variant",
        topicId: "bece_past_papers",
        format: "objective",
        paperType: 1,
        year: 2024,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2024 BECE Practical & Theory Essay Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Section A + Section B • 130 mins • 100 Marks",
        description: "Standardized 5-question practical and theory essay examination variant featuring Section A compulsory laboratory tests (Mammalian Heart, Planting Materials, DC Measurement Circuit, Separating Funnel) and Section B theory essays.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2024_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 2024,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2023 BECE Integrated Science Blueprint & Standardized CBT",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Objective Test",
        description: "Standardized 40-question objective examination variant with balanced key distribution (10 A, 10 B, 10 C, 10 D), KaTeX equations, diagnostic hints, and step-by-step worked solutions.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2023_variant",
        topicId: "bece_past_papers",
        format: "objective",
        paperType: 1,
        year: 2023,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2023 BECE Practical & Theory Essay Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Section A + Section B • 105 mins • 100 Marks",
        description: "Standardized 6-question practical and theory essay examination variant featuring Section A compulsory laboratory tests (Human Reproductive Systems [IMG_2614.jpg], Horticultural Farm Tools [IMG_2613.jpg], Forward-Biased Semiconductor Circuit with LED/Diode/Resistor, Solubility & Mixtures) and Section B theory essays.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2023_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 2023,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2025 BECE Integrated Science Blueprint & Standardized CBT",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Objective Test",
        description: "Standardized 40-question objective examination variant with balanced key distribution (10 A, 10 B, 10 C, 10 D), KaTeX equations, diagnostic hints, and step-by-step worked solutions.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2025_variant",
        topicId: "bece_past_papers",
        format: "objective",
        paperType: 1,
        year: 2025,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2025 BECE Practical & Theory Essay Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Section A + Section B • 130 mins • 100 Marks",
        description: "Standardized 5-question practical and theory essay examination variant featuring Section A compulsory laboratory tests (Carbon Cycle, Farming Systems, Inclined Plane, Distillation & Magnetic Separation) and Section B theory essays.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2025_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 2025,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2010 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized isomorphic practice variant of the 2010 BECE Integrated Science Paper 1. Contains 40 balanced objective questions with responsive NPN transistor and magnetic field vector SVGs, diagnostic hints, and full step-by-step solutions.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_2010_variant",
        topicId: "bece_past_papers",
        ...
        era: "classic",
        questionCount: 40,
        examTag: "Objective CBT • Standard Balanced Distribution",
        subject: "Integrated Science",
        status: "ready"
    },
    {
        ...
        subStrand: "2010 BECE Standardized Practical & Theory Essay Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Section A + Section B • 75 mins • 100 Marks",
        description: "Standardized practical and theory essay examination variant featuring Section A compulsory laboratory tests (DC series electrical circuit, qualitative litmus indicator tests & neutralization, human alimentary canal anatomy, agricultural garden cutlass) and Section B theory essays.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2010_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 2010,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "1990 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Modernized 4-option isomorphic practice variant of the vintage 1990 BECE Integrated Science Paper 1. Features 40 calibrated questions with simple distillation, first-class lever, and eye pupil regulation vector SVGs, diagnostic hints, and full step-by-step solutions.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_1990_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 1990,
    ...
    },
    {
        ...
        strandCode: "PRACTICAL-THEORY",
        subStrand: "1990 BECE Standardized Theory & Practical Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Section A + Section B • 60 mins • 60 Marks",
        description: "Standardized isomorphic practice variant of the 1990 BECE Integrated Science Paper 2 featuring comprehensive essay challenges: floral anatomy, energy transformations, levers & soil conservation, endemic disease control, salt/sand separation train, and sub-atomic particle architecture.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_1990_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 1990,
        ...
        era: "vintage",
        questionCount: 4,
        examTag: "Theory & Practical • Answer 3 of 4",
        subject: "Integrated Science",
        status: "ready"
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2009 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized isomorphic practice variant of the 2009 BECE Integrated Science Paper 1. Features 40 balanced objective questions (10 A, 10 B, 10 C, 10 D) with responsive DC series lamp circuit and reflection in plane mirror vector SVGs, diagnostic hints, and full step-by-step solutions.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_2009_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 2009,
    ...
    },
    {
        ...
        strandName: "SECTION A & SECTION B",
        strandCode: "PRACTICAL-THEORY",
        subStrand: "2009 BECE Standardized Practical & Theory Essay Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Section A + Section B • 75 mins • 75 Marks",
        description: "Standardized practical and theory essay examination variant featuring Section A compulsory laboratory tests (thermal conduction along metal bar with wax nails, atmospheric rusting setups, and leaf starch test activities) and Section B theory essays (balanced chemical equations, reflection, food chains, eye defects).",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2009_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 2009,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2008 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized isomorphic practice variant of the 2008 BECE Integrated Science Paper 1. Features 40 balanced objective questions (10 A, 10 B, 10 C, 10 D) with responsive specular reflection on plane mirror vector SVGs, diagnostic hints, and full step-by-step solutions.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_2008_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 2008,
    ...
    },
    {
        ...
        strandName: "SECTION A & SECTION B",
        strandCode: "PRACTICAL-THEORY",
        subStrand: "2008 BECE Standardized Practical & Theory Essay Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Section A + Section B • 75 mins • 75 Marks",
        description: "Standardized practical and theory essay examination variant featuring Section A compulsory laboratory tests (hydrostatic pressure in connected vessels, laboratory synthesis of ammonia gas with CaO drying tower, and variegated leaf starch test) and Section B theory essays.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2008_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 2008,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2007 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized isomorphic practice variant of the 2007 BECE Integrated Science Paper 1. Features 40 balanced objective questions (10 A, 10 B, 10 C, 10 D) with responsive light refraction bent stick vector SVGs, diagnostic hints, and full step-by-step solutions.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_2007_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 2007,
    ...
    },
    {
        ...
        strandName: "SECTION A & SECTION B",
        strandCode: "PRACTICAL-THEORY",
        subStrand: "2007 BECE Standardized Practical & Theory Essay Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Section A + Section B • 75 mins • 90 Marks",
        description: "Standardized practical and theory essay examination variant featuring Section A compulsory laboratory tests (single touch magnetization of bar AB, over-water gas generation and collection, exhaled breath limewater test) and Section B theory essays.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2007_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 2007,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2006 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized isomorphic practice variant of the 2006 BECE Integrated Science Paper 1. Features 40 balanced objective questions (10 A, 10 B, 10 C, 10 D) with glancing angle and reflection ray geometry vector SVGs, diagnostic hints, and full step-by-step solutions.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_2006_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 2006,
        ...
        era: "classic",
        questionCount: 40,
        examTag: "40 Objective Questions • Balanced Keys",
        subject: "Integrated Science",
        sampleInstruction: "A ray of light strikes a flat plane mirror such that the glancing angle is 20°. Determine the angle of reflection (r):",
        status: "ready"
    },
    {
        ...
        strandName: "SECTION A & SECTION B",
        strandCode: "PRACTICAL-THEORY",
        subStrand: "2006 BECE Standardized Practical & Theory Essay Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Section A + Section B • 75 mins • 90 Marks",
        description: "Standardized isomorphic practice variant of the 2006 BECE Integrated Science Paper 2. Compulsory Section A practical (electromagnetization of iron nail, carbon dioxide over-water preparation, salivary amylase yam pap hydrolysis) plus Section B theory essays with parallel lamp circuit diagrams.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2006_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 2006,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2005 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized isomorphic practice variant of the 2005 BECE Integrated Science Paper 1. Features 40 balanced objective questions (10 A, 10 B, 10 C, 10 D) with crowbar lever mechanics vector SVGs, diagnostic hints, and full step-by-step solutions.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_2005_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 2005,
        ...
        examTag: "40 Objective Questions • Balanced Keys",
        subject: "Integrated Science",
        sampleInstruction: "In the lever system illustrated below used to pry up a heavy stone, what technical term defines the distance X from the stone to the pivot?",
        status: "ready"
    },
    {
        ...
        strandName: "SECTION A & SECTION B",
        strandCode: "PRACTICAL-THEORY",
        subStrand: "2005 BECE Standardized Practical & Theory Essay Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Section A + Section B • 75 mins • 90 Marks",
        description: "Standardized isomorphic practice variant of the 2005 BECE Integrated Science Paper 2. Compulsory Section A practical (spouting cans hydrostatic pressure vs depth, neutralization of hydrochloric acid and sodium hydroxide, leaf starch testing) plus Section B theory essays with Class 2 lever systems.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2005_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 2005,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2004 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized isomorphic practice variant of the 2004 BECE Integrated Science Paper 1. Features 40 balanced objective questions (10 A, 10 B, 10 C, 10 D) with DC series vs parallel cells and Class 3 sugar tongs lever SVGs, diagnostic hints, and full step-by-step solutions.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_2004_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 2004,
        ...
        examTag: "40 Objective Questions • Balanced Keys",
        subject: "Integrated Science",
        sampleInstruction: "Study the circuit diagrams X and Y below. Which statement is scientifically correct regarding the arrangement of cells?",
        status: "ready"
    },
    {
        ...
        strandName: "SECTION A & SECTION B",
        strandCode: "PRACTICAL-THEORY",
        subStrand: "2004 BECE Standardized Practical & Theory Essay Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Section A + Section B • 75 mins • 90 Marks",
        description: "Standardized isomorphic practice variant of the 2004 BECE Integrated Science Paper 2. Compulsory Section A practical (direct current ammeter/voltmeter/rheostat circuit, fractional distillation of water and alcohol, qualitative food tests table) plus Section B theory essays with endocrine glands and ammonia preparation.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2004_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 2004,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2003 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized isomorphic practice variant of the 2003 BECE Integrated Science Paper 1. Features 40 balanced objective questions (10 A, 10 B, 10 C, 10 D) with soil sedimentation cylinder textural stratification vector SVGs, diagnostic hints, and full step-by-step solutions.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_2003_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 2003,
        ...
        examTag: "40 Objective Questions • Balanced Keys",
        subject: "Integrated Science",
        sampleInstruction: "In the soil sedimentation cylinder illustrated below, which labelled horizontal layer contains floating organic humus matter?",
        status: "ready"
    },
    {
        ...
        subStrand: "2003 BECE Standardized Practical & Theory Essay Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "4 Comprehensive Questions • 75 mins • 80 Marks",
        description: "Standardized isomorphic practice variant of the 2003 BECE Integrated Science Paper 2. Four comprehensive 20-mark theory questions with embedded series circuit SVGs covering photosynthesis and salt-sand separation, epidemiology and starch testing, blood components and insulators, and excretion and gas compressibility.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2003_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 2003,
        ...
        era: "classic",
        questionCount: 4,
        examTag: "Comprehensive Theory & Practical • 80 Marks",
        subject: "Integrated Science",
        status: "ready"
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2001 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized isomorphic practice variant of the 2001 BECE Integrated Science Paper 1. Features 40 balanced objective questions (10 A, 10 B, 10 C, 10 D) with balanced lever systems and electromagnetic solenoids vector SVGs, diagnostic hints, and full step-by-step solutions.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_2001_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 2001,
    ...
    },
    {
        ...
        strandName: "THEORY & PRACTICAL ESSAYS",
        strandCode: "THEORY-ESSAY",
        subStrand: "2001 BECE Standardized Practical & Theory Essay Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "4 Comprehensive Questions • 75 mins • 80 Marks",
        description: "Standardized isomorphic practice variant of the 2001 BECE Integrated Science Paper 2. Four comprehensive 20-mark theory questions with embedded vector SVGs covering surface tension, nutrition, electrical circuits, electromagnetism, astronomical solar eclipses, and ecology.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2001_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 2001,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2000 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized isomorphic practice variant of the 2000 BECE Integrated Science Paper 1. Features 40 balanced objective questions (10 A, 10 B, 10 C, 10 D) with hypermetropia optical ray diagrams, diagnostic hints, and full step-by-step solutions.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_2000_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 2000,
    ...
    },
    {
        ...
        strandName: "THEORY & PRACTICAL ESSAYS",
        strandCode: "THEORY-ESSAY",
        subStrand: "2000 BECE Standardized Practical & Theory Essay Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "4 Comprehensive Questions • 75 mins • 80 Marks",
        description: "Standardized isomorphic practice variant of the 2000 BECE Integrated Science Paper 2. Four comprehensive 20-mark theory questions with responsive lifting work mechanics SVGs covering hygiene, matter classification, levers, satellites, electrostatics, separation science, floral morphology, syngamic fertilization, density, and energy.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2000_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 2000,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2011 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized isomorphic practice variant of the 2011 BECE Integrated Science Paper 1. Contains 40 balanced objective questions with responsive angiosperm stamen and biological hierarchy vector SVGs, diagnostic hints, and full step-by-step solutions.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_2011_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 2011,
    ...
    },
    {
        ...
        strandName: "SECTION A & SECTION B",
        strandCode: "PRACTICAL-THEORY",
        subStrand: "2011 BECE Standardized Practical & Theory Essay Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Section A + Section B • 75 mins • 100 Marks",
        description: "Standardized practical and theory essay examination variant featuring Section A compulsory laboratory tests (pinhole cardboard rectilinear propagation of light, standard hazard pictograms, mammalian dentition anatomy, agricultural hand tools) and Section B theory essays.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2011_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 2011,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2016 BECE Integrated Science Standardized CBT",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • Objective Test",
        description: "Standardized 40-question objective examination variant with KaTeX equations, vector SVGs, and step-by-step worked solutions for 2016 BECE candidates.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_2016_variant",
        topicId: "bece_past_papers",
        format: "objective",
        paperType: 1,
        year: 2016,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2016 BECE Practical & Theory Essay Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Section A + Section B • 75 mins • 100 Marks",
        description: "Standardized 6-question practical and theory essay examination variant featuring Section A compulsory laboratory tests (comparative soil drainage, hazard warning pictograms, simple machines, human alimentary canal) and Section B theory essays.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2016_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 2016,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2019 BECE Objective Test Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "40 Questions • 45 mins • 100% Curriculum Calibrated",
        description: "Standardized 40-question objective examination variant covering metallurgy, atomic structure, levers, fluid mechanics, and plant/animal physiology with step-by-step diagnostic solutions.",
        difficulty: "Standard",
        kind: "exam_series",
    ...
    },
{
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2019 BECE Practical & Theory Essay Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Section A + Section B • 75 mins • 100 Marks",
        description: "Standardized 5-question practical and theory essay examination variant featuring Section A compulsory laboratory tests (rusting of iron nails, leaf starch test, soil water-holding capacity, thermal conduction) and Section B theory essays.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2019_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 2019,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2018 BECE Practical & Theory Essay Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Section A + Section B • 75 mins • 100 Marks",
        description: "Standardized practical and theory essay examination variant featuring Section A compulsory laboratory tests (bony fish anatomy, soil profile cross-section, resistance investigation circuit, neutralization reaction) and Section B theory essays.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2018_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 2018,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2021 BECE Practical & Theory Essay Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Section A + Section B • 75 mins • 100 Marks",
        description: "Standardized practical and theory essay examination variant featuring Section A compulsory laboratory tests (gravitational potential energy & free-fall, comparative dentition, horticultural vegetable classification, phase changes of water) and Section B theory essays.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2021_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 2021,
    ...
    },
    {
        ...
        strandName: "SECTION A & SECTION B",
        strandCode: "PRACTICAL-THEORY",
        subStrand: "2012 BECE Standardized Practical & Theory Essay Test",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Section A + Section B • 75 mins • 100 Marks",
        description: "Standardized practical and theory essay examination variant featuring Section A compulsory laboratory tests (measuring cylinder sinker method for volume/density of cork, standard solution preparation apparatus set, flowering plant anatomy, domestic rabbit external features) and Section B theory essays.",
        difficulty: "Advanced",
        kind: "exam_series",
        setId: "paper_2012_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 2012,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2022 BECE Practical & Theory Essay Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Section A + Section B • 75 mins • 100 Marks",
        description: "Standardized practical and theory essay examination variant featuring Section A compulsory laboratory tests (filtration vs. magnetic separation, respiratory anatomy, soil thermometer ecology, series vs. parallel resistor circuits) and Section B theory essays.",
        difficulty: "Advanced",
        kind: "exam_series",
    ...
    },
    {
        ...
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized 40-question objective examination variant with balanced key distribution (10 A, 10 B, 10 C, 10 D), KaTeX equations, diagnostic hints, and step-by-step worked solutions for metrology, plant/animal physiology, mechanics, and chemistry.",
        difficulty: "Intermediate",
        kind: "exam_series",
        ...
        era: "legacy",
        questionCount: 40,
        examTag: "Objective CBT • 10 A, 10 B, 10 C, 10 D",
        subject: "Integrated Science",
        status: "ready"
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2013 BECE Practical & Theory Essay Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Section A + Section B • 105 mins • 100 Marks",
        description: "Standardized practical and theory essay examination variant featuring Section A compulsory laboratory tests (Living Tissue Osmometer Experiment [IMG_2615.jpg], Metal-Acid Displacement [IMG_2616.jpg], Vacuum Thermos Flask Anatomy [IMG_2617.jpg], Soil Drainage Cylinders X, Y, Z [IMG_2618.jpg]) and Section B theory essays.",
        difficulty: "Advanced",
        kind: "exam_series",
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "1991 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized 40-question objective examination variant with balanced key distribution (10 A, 10 B, 10 C, 10 D), KaTeX equations, diagnostic hints, and step-by-step worked solutions for digestive enzymology, photosynthesis, work mechanics, thermal physics, and taxonomy.",
        difficulty: "Core",
        kind: "exam_series",
        setId: "paper_1991_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 1991,
    ...
    },
    {
        ...
        era: "legacy",
        questionCount: 4,
        examTag: "Practical & Theory • 4 Questions",
        subject: "Integrated Science",
        status: "ready"
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "1992 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized 40-question objective examination variant with balanced key distribution (10 A, 10 B, 10 C, 10 D), KaTeX equations, diagnostic hints, and step-by-step worked solutions for matter physics, valency, separation methods, and ecological physiology.",
        difficulty: "Core",
        kind: "exam_series",
        setId: "paper_1992_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 1992,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "1993 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized 40-question objective examination variant with balanced key distribution (10 A, 10 B, 10 C, 10 D), KaTeX equations, diagnostic hints, and step-by-step worked solutions covering states of matter, soil erosion, human physiology, alloys, and kinematics.",
        difficulty: "Core",
        kind: "exam_series",
        setId: "paper_1993_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 1993,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "1993 BECE Practical & Theory Essay Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "4 Questions • 75 mins • 80 Marks",
        description: "Standardized practical and theory essay examination variant featuring element/compound/mixture classification, gravitational potential energy calculation (2,000 J), pinhole camera ray diagram with vector SVG, two laws of reflection, electromagnet solenoid circuit with vector SVG, malaria clinical symptoms, satellite physics, and duodenal starch digestion.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_1993_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 1993,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "1994 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized 40-question objective examination variant with balanced key distribution (10 A, 10 B, 10 C, 10 D), KaTeX equations, diagnostic hints, and step-by-step worked solutions covering triple point states of matter, simple machines, nutrition, hydrogeology, and ecology.",
        difficulty: "Core",
        kind: "exam_series",
        setId: "paper_1994_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 1994,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "1994 BECE Practical & Theory Essay Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "4 Questions • 75 mins • 80 Marks",
        description: "Standardized practical and theory essay examination variant featuring physical vs. chemical changes, digestion end-products, first-class crowbar lever calculation with vector SVG, solar system planets, work calculation (160 J), and two cells in series vs. parallel with vector SVG.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_1994_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 1994,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "1995 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized 40-question objective examination variant with balanced key distribution (10 A, 10 B, 10 C, 10 D), KaTeX equations, diagnostic hints, and step-by-step worked solutions covering soil conservation, mass vs. weight, convection, separation science, thermometry, and heliocentric planetary mechanics.",
        difficulty: "Core",
        kind: "exam_series",
        setId: "paper_1995_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 1995,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "1995 BECE Practical & Theory Essay Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "4 Questions • 75 mins • 80 Marks",
        description: "Standardized practical and theory essay examination variant featuring fluid capillarity with vector SVG, human eye sagittal section with vector SVG, visual defect optics, simple machine mechanical advantage (MA = 20.0), vegetative propagation of crops, and soil bulk density determination.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_1995_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 1995,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "1996 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized 40-question objective examination variant with balanced key distribution (10 A, 10 B, 10 C, 10 D), KaTeX equations, diagnostic hints, and step-by-step worked solutions covering sexually transmitted infections, excretory systems, crop rotation, work mechanics, biological hierarchy, thermodynamics, and lunar craters.",
        difficulty: "Core",
        kind: "exam_series",
        setId: "paper_1996_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 1996,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "1996 BECE Practical & Theory Essay Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "4 Questions • 75 mins • 80 Marks",
        description: "Standardized practical and theory essay examination variant featuring mammalian female reproductive tract with vector SVG, solar eclipse ray tracing with vector SVG, Bohr atomic shell architecture of oxygen (2,6) with vector SVG, work/force mechanics (F = 30.0 N), and food preservation principles.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_1996_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 1996,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "1997 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized 40-question objective examination variant with balanced key distribution (10 A, 10 B, 10 C, 10 D), KaTeX equations, diagnostic hints, and step-by-step worked solutions covering intestinal absorption, ectoparasitology, soil liming, Milky Way cosmology, food testing, immunization, and centripetal mechanics.",
        difficulty: "Core",
        kind: "exam_series",
        setId: "paper_1997_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 1997,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "1997 BECE Practical & Theory Essay Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "4 Questions • 75 mins • 80 Marks",
        description: "Standardized practical and theory essay examination variant featuring fluid viscosity comparison tubes with vector SVG, two dry cells in parallel DC circuit with vector SVG, candle combustion bell-jar experiment with vector SVG, osmosis, and neutralization stoichiometry.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_1997_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 1997,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "1998 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized 40-question objective examination variant with balanced key distribution (10 A, 10 B, 10 C, 10 D), KaTeX equations, diagnostic hints, and step-by-step worked solutions covering fish preservation, hectare metric land conversion, ringworm dermatophytes, CNS neuroanatomy, mechanical work, photosynthesis substrates, equinoxes, states of matter, and alveolar gas exchange vector histology.",
        difficulty: "Core",
        kind: "exam_series",
        setId: "paper_1998_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 1998,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "1998 BECE Practical & Theory Essay Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "4 Questions • 75 mins • 80 Marks",
        description: "Standardized practical and theory essay examination variant featuring planet vs star astronomy, liquid surface tension, modified stem classification, binary nomenclature, soil macronutrients, stone density displacement, sand bulk mass, atomic neutrality, thermal expansion, litmus reactions, digestive health, plant herbivore defenses, insect pollination, and Lithium Z=3 Bohr atomic structure vector SVG.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_1998_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 1998,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "1999 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized 40-question objective examination variant with balanced key distribution (10 A, 10 B, 10 C, 10 D), KaTeX equations, diagnostic hints, and step-by-step worked solutions covering mixture separation, gullet anatomy, bilharziasis blood flukes, salivary amylase hydrolysis, atomic neutrality, avian flight adaptations, machine efficiency, and solar radiation.",
        difficulty: "Core",
        kind: "exam_series",
        setId: "paper_1999_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 1999,
    ...
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "1999 BECE Practical & Theory Essay Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "4 Questions • 75 mins • 80 Marks",
        description: "Standardized practical and theory essay examination variant featuring expired air limewater carbon dioxide test with vector SVG, second-class lever mechanics with vector SVG, synthesis of iron (II) sulfide with vector SVG, kenkey mastication, sequential digestive tract, and mechanical work calculations.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_1999_variant_p2",
        topicId: "bece_past_papers",
        format: "structured_essay",
        paperType: 2,
        year: 1999,
    ...
    {
        title: "BECE Integrated Science Mock 1 (Set 132 Practical & Theory)",
        domain: "SCIENTIFIC INQUIRY & PRACTICAL LABS",
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        ...
        era: "modern",
        questionCount: 5,
        examTag: "Practical & Theory • 100 Marks",
        subject: "Integrated Science",
        status: "ready"
    },
    {
        ...
        strandName: "STRAND 1 TO STRAND 5",
        strandCode: "S1-S5",
        subStrand: "2012 BECE Standardized Objective Examination",
        gradeTier: "Junior Secondary (JHS)",
        meta: "Paper 1 (40 Questions) • 45 mins • 40 Marks",
        description: "Standardized isomorphic practice variant of the 2012 BECE Integrated Science Paper 1. Contains 40 balanced objective questions with responsive transistor/plane mirror vector SVGs, diagnostic hints, and full step-by-step solutions.",
        difficulty: "Intermediate",
        kind: "exam_series",
        setId: "paper_2012_variant",
        topicId: "bece_past_papers",
        format: "multiple_choice",
        paperType: 1,
        year: 2012,
...
function resolveExamMetadata(exam: any): ResolvedExamMeta {
  ...
  const setYearMap: Record<number, { year: number; paper: 1 | 2 }> = {
    ...
    91: { year: 2013, paper: 2 },
    90: { year: 2013, paper: 1 },
    89: { year: 2022, paper: 2 },
    88: { year: 2022, paper: 1 },
    87: { year: 2021, paper: 2 },
    ...
    114: { year: 2001, paper: 1 },
    115: { year: 2001, paper: 2 },
    116: { year: 2000, paper: 1 },
    117: { year: 2000, paper: 2 },
    118: { year: 2025, paper: 1 },
    119: { year: 2025, paper: 2 },
    120: { year: 2024, paper: 1 },
    121: { year: 2023, paper: 1 },
    122: { year: 2013, paper: 1 },
    123: { year: 1991, paper: 1 },
    124: { year: 1992, paper: 1 },
    125: { year: 1993, paper: 1 },
    126: { year: 1994, paper: 1 },
    127: { year: 1995, paper: 1 },
    128: { year: 1996, paper: 1 },
...
function findModuleForExam(modules: SuggestedModuleCard[], examId?: string, paperType?: string | number): SuggestedModuleCard | null {
    ...
    const catalogMap: Record<string, { setNum: number; paper?: number; year?: number }> = {
        ...
        'paper_2013_variant': { setNum: 122, paper: 1, year: 2013 },
        'paper_mock_1': { setNum: 132, paper: 1, year: 2026 },
        'paper_mock_1_p1': { setNum: 132, paper: 1, year: 2026 },
        'paper_mock_1_p2': { setNum: 132, paper: 2, year: 2026 },
        'paper_mock_2': { setNum: 133, paper: 1, year: 2026 },
        'paper_mock_2_p1': { setNum: 133, paper: 1, year: 2026 },
        'paper_mock_2_p2': { setNum: 133, paper: 2, year: 2026 },
        'paper_mock_3': { setNum: 134, paper: 1, year: 2026 },
        'paper_mock_3_p1': { setNum: 134, paper: 1, year: 2026 },
        'paper_mock_3_p2': { setNum: 134, paper: 2, year: 2026 },
        'paper_mock_4': { setNum: 135, paper: 1, year: 2026 },
        'paper_mock_4_p1': { setNum: 135, paper: 1, year: 2026 },
        'paper_mock_4_p2': { setNum: 135, paper: 2, year: 2026 },
        'paper_1999_variant': modules[0]?.subject === 'Mathematics' ? { setNum: 27, paper: 1, year: 1999 } : { setNum: 131, paper: 1, year: 1999 },
        'paper_1999_variant_p1': { setNum: 131, paper: 1, year: 1999 },
        'paper_1999_variant_p2': { setNum: 131, paper: 2, year: 1999 },
        'paper_1998_variant': modules[0]?.subject === 'Mathematics' ? { setNum: 29, paper: 1, year: 1998 } : { setNum: 130, paper: 1, year: 1998 },
        'paper_1998_variant_p1': { setNum: 130, paper: 1, year: 1998 },
        'paper_1998_variant_p2': { setNum: 130, paper: 2, year: 1998 },
        'paper_1997_variant': modules[0]?.subject === 'Mathematics' ? { setNum: 31, paper: 1, year: 1997 } : { setNum: 129, paper: 1, year: 1997 },
        'paper_1997_variant_p1': { setNum: 129, paper: 1, year: 1997 },
        'paper_1997_variant_p2': { setNum: 129, paper: 2, year: 1997 },
        'paper_1996_variant': modules[0]?.subject === 'Mathematics' ? { setNum: 33, paper: 1, year: 1996 } : { setNum: 128, paper: 1, year: 1996 },
        'paper_1996_variant_p1': { setNum: 128, paper: 1, year: 1996 },
        'paper_1996_variant_p2': { setNum: 128, paper: 2, year: 1996 },
        'paper_1995_variant': modules[0]?.subject === 'Mathematics' ? { setNum: 35, paper: 1, year: 1995 } : { setNum: 127, paper: 1, year: 1995 },
        'paper_1995_variant_p1': { setNum: 127, paper: 1, year: 1995 },
        'paper_1995_variant_p2': { setNum: 127, paper: 2, year: 1995 },
        'paper_1994_variant': modules[0]?.subject === 'Mathematics' ? { setNum: 37, paper: 1, year: 1994 } : { setNum: 126, paper: 1, year: 1994 },
        'paper_1994_variant_p1': { setNum: 126, paper: 1, year: 1994 },
        'paper_1994_variant_p2': { setNum: 126, paper: 2, year: 1994 },
        'paper_1993_variant': modules[0]?.subject === 'Mathematics' ? { setNum: 39, paper: 1, year: 1993 } : { setNum: 125, paper: 1, year: 1993 },
        'paper_1993_variant_p1': { setNum: 125, paper: 1, year: 1993 },
        'paper_1993_variant_p2': { setNum: 125, paper: 2, year: 1993 },
        'paper_1992_variant': modules[0]?.subject === 'Mathematics' ? { setNum: 41, paper: 1, year: 1992 } : { setNum: 124, paper: 1, year: 1992 },
        'paper_1992_variant_p1': { setNum: 124, paper: 1, year: 1992 },
        'paper_1992_variant_p2': { setNum: 124, paper: 2, year: 1992 },
        'paper_1991_variant': { setNum: 123, paper: 1, year: 1991 },
        'paper_1991_variant_p1': { setNum: 123, paper: 1, year: 1991 },
        'paper_1991_variant_p2': { setNum: 123, paper: 2, year: 1991 },
        'paper_2013_variant_p1': { setNum: 122, paper: 1, year: 2013 },
        'paper_2013_variant_p2': { setNum: 122, paper: 2, year: 2013 },
        'paper_2012_variant': { setNum: 92, paper: 1, year: 2012 },
        'paper_2012_variant_p2': { setNum: 93, paper: 2, year: 2012 },
        'paper_2011_variant': { setNum: 94, paper: 1, year: 2011 },
        'paper_2011_variant_p2': { setNum: 95, paper: 2, year: 2011 },
        'paper_2010_variant': { setNum: 96, paper: 1, year: 2010 },
        'paper_2010_variant_p2': { setNum: 97, paper: 2, year: 2010 },
        'paper_1990_variant': { setNum: 98, paper: 1, year: 1990 },
        'paper_1990_variant_p2': { setNum: 99, paper: 2, year: 1990 },
        'paper_2009_variant': { setNum: 100, paper: 1, year: 2009 },
        'paper_2009_variant_p1': { setNum: 100, paper: 1, year: 2009 },
        'paper_2009_variant_p2': { setNum: 101, paper: 2, year: 2009 },
        'paper_2008_variant': { setNum: 102, paper: 1, year: 2008 },
        'paper_2008_variant_p1': { setNum: 102, paper: 1, year: 2008 },
        'paper_2008_variant_p2': { setNum: 103, paper: 2, year: 2008 },
        'paper_2007_variant': { setNum: 104, paper: 1, year: 2007 },
        'paper_2007_variant_p1': { setNum: 104, paper: 1, year: 2007 },
        'paper_2007_variant_p2': { setNum: 105, paper: 2, year: 2007 },
        'paper_2006_variant': { setNum: 106, paper: 1, year: 2006 },
        'paper_2006_variant_p1': { setNum: 106, paper: 1, year: 2006 },
        'paper_2006_variant_p2': { setNum: 107, paper: 2, year: 2006 },
        'paper_2005_variant': { setNum: 108, paper: 1, year: 2005 },
        'paper_2005_variant_p1': { setNum: 108, paper: 1, year: 2005 },
        'paper_2005_variant_p2': { setNum: 109, paper: 2, year: 2005 },
        'paper_2004_variant': { setNum: 110, paper: 1, year: 2004 },
        'paper_2004_variant_p1': { setNum: 110, paper: 1, year: 2004 },
        'paper_2004_variant_p2': { setNum: 111, paper: 2, year: 2004 },
        'paper_2003_variant': { setNum: 112, paper: 1, year: 2003 },
        'paper_2003_variant_p1': { setNum: 112, paper: 1, year: 2003 },
        'paper_2003_variant_p2': { setNum: 113, paper: 2, year: 2003 },
        'paper_2001_variant': { setNum: 114, paper: 1, year: 2001 },
        'paper_2001_variant_p1': { setNum: 114, paper: 1, year: 2001 },
        'paper_2001_variant_p2': { setNum: 115, paper: 2, year: 2001 },
        'paper_2000_variant': { setNum: 116, paper: 1, year: 2000 },
        'paper_2000_variant_p1': { setNum: 116, paper: 1, year: 2000 },
        'paper_2000_variant_p2': { setNum: 117, paper: 2, year: 2000 },
        'paper_2025_variant': modules[0]?.subject === 'Mathematics' ? { setNum: 65, paper: 2, year: 2025 } : { setNum: 118, paper: 1, year: 2025 },
        'paper_2025_variant_p1': { setNum: 118, paper: 1, year: 2025 },
        'paper_2025_variant_p2': { setNum: 119, paper: 2, year: 2025 },
        'paper_2025_p1_variant': { setNum: 65, paper: 1, year: 2025 },
        'paper_2024_variant': modules[0]?.subject === 'Mathematics' ? { setNum: 60, paper: 2, year: 2024 } : { setNum: 120, paper: 1, year: 2024 },
        'paper_2024_variant_p1': { setNum: 120, paper: 1, year: 2024 },
        'paper_2024_variant_p2': { setNum: 120, paper: 2, year: 2024 },
        'paper_2024_p1_variant': { setNum: 60, paper: 1, year: 2024 },
        'paper_2023_variant': modules[0]?.subject === 'Mathematics' ? { setNum: 59, paper: 2, year: 2023 } : { setNum: 121, paper: 1, year: 2023 },
        'paper_2023_variant_p1': { setNum: 121, paper: 1, year: 2023 },
        'paper_2023_variant_p2': { setNum: 121, paper: 2, year: 2023 },
                ...
                if (sets && sets.length > 0) {
                    sets.forEach((s) => {
                        ...
                        scanned.push({
                            ...
                            gradeTier: activeGrade,
                            meta: `${s.totalQuestions || s.questions?.length || 40} Questions • 60 mins • ${s.variantType === 'past_paper_variant' ? 'Curriculum-Aligned Model' : 'Mastery Series'}`,
...
const ENGLISH_MOCK_SUITES: MockSuiteItem[] = [
    ...
    const handleLaunchMockPaper = async (mockNum: number, paperNum: 1 | 2) => {
        ...
        if (mockNum === 1) {
            ...
            await handleLaunchModule({
                title: paperNum === 1 
                    ? "BECE Integrated Science Mock 2 (Set 133 Objective)" 
                    : "BECE Integrated Science Mock 2 (Set 133 Practical & Theory)",
                domain: paperNum === 1 ? "COMPREHENSIVE MOCK CURRICULUM" : "SCIENTIFIC INQUIRY & PRACTICAL LABS",
                strandName: "STRAND 1 TO STRAND 5",
                strandCode: "S1-S5",
                subStrand: paperNum === 1 
                    ? "High-Fidelity Standard Mock 2 Objective" 
                    : "High-Fidelity Standard Mock 2 Practical & Theory",
                gradeTier: "Junior Secondary (JHS)",
                meta: paperNum === 1 ? "Paper 1 (40 Questions) • 45 mins • 40 Marks" : "Section A & B (5 Questions) • 105 mins • 100 Marks",
                description: paperNum === 1 
                    ? "Standardized 40-question objective examination synthesizing three decades of longitudinal BECE science curriculum trends with balanced key distribution (10 A, 10 B, 10 C, 10 D)."
                    : "Standardized practical and theory essay examination featuring Ohm's law circuit verification, soil porosity & drainage, leaf starch decolorization test, and soil profile horizons.",
                difficulty: paperNum === 1 ? "Core" : "Advanced",
                kind: "mock_suite",
                setId: paperNum === 1 ? "paper_mock_2" : "paper_mock_2_p2",
                topicId: "mock_exams",
                format: paperNum === 1 ? "multiple_choice" : "structured_essay",
                paperType: paperNum,
                year: 2026,
            ...
            await handleLaunchModule({
                title: paperNum === 1 
                    ? "BECE Integrated Science Mock 3 (Set 134 Objective)" 
                    : "BECE Integrated Science Mock 3 (Set 134 Practical & Theory)",
                domain: paperNum === 1 ? "COMPREHENSIVE MOCK CURRICULUM" : "SCIENTIFIC INQUIRY & PRACTICAL LABS",
                strandName: "STRAND 1 TO STRAND 5",
                strandCode: "S1-S5",
                subStrand: paperNum === 1 
                    ? "High-Fidelity Standard Mock 3 Objective" 
                    : "High-Fidelity Standard Mock 3 Practical & Theory",
                gradeTier: "Junior Secondary (JHS)",
                meta: paperNum === 1 ? "Paper 1 (40 Questions) • 45 mins • 40 Marks" : "Section A & B (5 Questions) • 105 mins • 100 Marks",
                description: paperNum === 1 
                    ...
                    : "Standardized practical and theory essay examination featuring chemical food tests, pinhole camera ray diagram, separating funnel immiscible liquids, and mammalian digestive systems.",
                difficulty: paperNum === 1 ? "Core" : "Advanced",
                kind: "mock_suite",
                setId: paperNum === 1 ? "paper_mock_3" : "paper_mock_3_p2",
                topicId: "mock_exams",
                format: paperNum === 1 ? "multiple_choice" : "structured_essay",
                paperType: paperNum,
                year: 2026,
            ...
            await handleLaunchModule({
                title: paperNum === 1 
                    ? "BECE Integrated Science Mock 4 (Set 135 Objective)" 
                    : "BECE Integrated Science Mock 4 (Set 135 Practical & Theory)",
                domain: paperNum === 1 ? "COMPREHENSIVE MOCK CURRICULUM" : "SCIENTIFIC INQUIRY & PRACTICAL LABS",
                strandName: "STRAND 1 TO STRAND 5",
                strandCode: "S1-S5",
                subStrand: paperNum === 1 
                    ? "High-Fidelity Standard Mock 4 Objective" 
                    : "High-Fidelity Standard Mock 4 Practical & Theory",
                gradeTier: "Junior Secondary (JHS)",
                meta: paperNum === 1 ? "Paper 1 (40 Questions) • 45 mins • 40 Marks" : "Section A & B (5 Questions) • 105 mins • 100 Marks",
                description: paperNum === 1 
                    ? "Standardized 40-question objective examination synthesizing NaCCA BECE science curriculum standards with balanced key distribution (10 A, 10 B, 10 C, 10 D)."
                    : "Standardized practical and theory essay examination featuring dispersion of white light, simple distillation, plant cell plasmolysis, and horticultural farm hand tools.",
                difficulty: paperNum === 1 ? "Core" : "Advanced",
                kind: "mock_suite",
                setId: paperNum === 1 ? "paper_mock_4" : "paper_mock_4_p2",
                topicId: "mock_exams",
                format: paperNum === 1 ? "multiple_choice" : "structured_essay",
                paperType: paperNum,
                year: 2026,
            ...
            await handleLaunchModule({
                title: paperNum === 1 
                    ? "BECE Integrated Science Mock 6 (Set 137 Objective)" 
                    : "BECE Integrated Science Mock 6 (Set 137 Practical & Theory)",
                domain: paperNum === 1 ? "COMPREHENSIVE MOCK CURRICULUM" : "SCIENTIFIC INQUIRY & PRACTICAL LABS",
                strandName: "STRAND 1 TO STRAND 5",
                strandCode: "S1-S5",
                subStrand: paperNum === 1 
                    ? "High-Fidelity Standard Mock 6 Objective" 
                    : "High-Fidelity Standard Mock 6 Practical & Theory",
                gradeTier: "Junior Secondary (JHS)",
                meta: paperNum === 1 ? "Paper 1 (40 Questions) • 45 mins • 40 Marks" : "Section A & B (5 Questions) • 105 mins • 100 Marks",
                description: paperNum === 1 
                    ? "Standardized 40-question objective examination synthesizing NaCCA BECE science curriculum standards with balanced key distribution (10 A, 10 B, 10 C, 10 D)."
                    : "Standardized practical and theory essay examination featuring bar magnet field lines, fractional distillation, human tooth anatomy, and vegetative propagation.",
                difficulty: paperNum === 1 ? "Core" : "Advanced",
                kind: "mock_suite",
                setId: paperNum === 1 ? "paper_mock_6" : "paper_mock_6_p2",
                topicId: "mock_exams",
                format: paperNum === 1 ? "multiple_choice" : "structured_essay",
                paperType: paperNum,
                year: 2026,
            ...
            await handleLaunchModule({
                title: paperNum === 1 
                    ? "BECE Integrated Science Mock 7 (Set 138 Objective)" 
                    : "BECE Integrated Science Mock 7 (Set 138 Practical & Theory)",
                domain: paperNum === 1 ? "COMPREHENSIVE MOCK CURRICULUM" : "SCIENTIFIC INQUIRY & PRACTICAL LABS",
                strandName: "STRAND 1 TO STRAND 5",
                strandCode: "S1-S5",
                subStrand: paperNum === 1 
                    ? "High-Fidelity Standard Mock 7 Objective" 
                    : "High-Fidelity Standard Mock 7 Practical & Theory",
                gradeTier: "Junior Secondary (JHS)",
                meta: paperNum === 1 ? "Paper 1 (40 Questions) • 45 mins • 40 Marks" : "Section A & B (5 Questions) • 105 mins • 100 Marks",
                description: paperNum === 1 
                    ? "Standardized 40-question objective examination synthesizing NaCCA BECE science curriculum standards with balanced key distribution (10 A, 10 B, 10 C, 10 D)."
                    : "Standardized practical and theory essay examination featuring rectilinear propagation of light, water hardness, epigeal vs. hypogeal germination, and soil profile horizons.",
                difficulty: paperNum === 1 ? "Core" : "Advanced",
                kind: "mock_suite",
                setId: paperNum === 1 ? "paper_mock_7" : "paper_mock_7_p2",
                topicId: "mock_exams",
                format: paperNum === 1 ? "multiple_choice" : "structured_essay",
                paperType: paperNum,
                year: 2026,
            ...
            await handleLaunchModule({
                title: paperNum === 1 
                    ? "BECE Integrated Science Mock 8 (Set 139 Objective)" 
                    : "BECE Integrated Science Mock 8 (Set 139 Practical & Theory)",
                domain: paperNum === 1 ? "COMPREHENSIVE MOCK CURRICULUM" : "SCIENTIFIC INQUIRY & PRACTICAL LABS",
                strandName: "STRAND 1 TO STRAND 5",
                strandCode: "S1-S5",
                subStrand: paperNum === 1 
                    ? "Comprehensive National Standards Mock 8 Objective" 
                    : "Comprehensive National Standards Mock 8 Practical & Theory",
                gradeTier: "Junior Secondary (JHS)",
                meta: paperNum === 1 ? "Paper 1 (40 Questions) • 45 mins • 40 Marks" : "Section A & B (5 Questions) • 105 mins • 100 Marks",
                description: paperNum === 1 
                    ? "Standardized 40-question objective examination synthesizing NaCCA BECE science curriculum standards with balanced key distribution (10 A, 10 B, 10 C, 10 D)."
                    : "Standardized practical and theory essay examination featuring atmospheric crushing can, chemical tests for water, mammalian ear anatomy, and livestock parasites.",
                difficulty: paperNum === 1 ? "Core" : "Advanced",
                kind: "mock_suite",
                setId: paperNum === 1 ? "paper_mock_8" : "paper_mock_8_p2",
                topicId: "mock_exams",
                format: paperNum === 1 ? "multiple_choice" : "structured_essay",
                paperType: paperNum,
                year: 2026,
            ...
            await handleLaunchModule({
                title: paperNum === 1 
                    ? "BECE Integrated Science Mock 9 (Set 140 Objective)" 
                    : "BECE Integrated Science Mock 9 (Set 140 Practical & Theory)",
                domain: paperNum === 1 ? "COMPREHENSIVE MOCK CURRICULUM" : "SCIENTIFIC INQUIRY & PRACTICAL LABS",
                strandName: "STRAND 1 TO STRAND 5",
                strandCode: "S1-S5",
                subStrand: paperNum === 1 
                    ? "National Standards-Compliant Mock 9 Objective" 
                    : "National Standards-Compliant Mock 9 Practical & Theory",
                gradeTier: "Junior Secondary (JHS)",
                meta: paperNum === 1 ? "Paper 1 (40 Questions) • 45 mins • 40 Marks" : "Section A & B (5 Questions) • 105 mins • 100 Marks",
                description: paperNum === 1 
                    ? "Standardized 40-question objective examination synthesizing NaCCA BECE science curriculum standards with balanced key distribution (10 A, 10 B, 10 C, 10 D)."
                    : "Standardized practical and theory essay examination featuring pinhole camera ray optics, separating funnel immiscibility, bony fish morphology, and poultry housing systems.",
                difficulty: paperNum === 1 ? "Core" : "Advanced",
                kind: "mock_suite",
                setId: paperNum === 1 ? "paper_mock_9" : "paper_mock_9_p2",
                topicId: "mock_exams",
                format: paperNum === 1 ? "multiple_choice" : "structured_essay",
                paperType: paperNum,
                year: 2026,
            ...
            await handleLaunchModule({
                title: paperNum === 1 
                    ? "BECE Integrated Science Mock 10 (Set 141 Objective)" 
                    : "BECE Integrated Science Mock 10 (Set 141 Practical & Theory)",
                domain: paperNum === 1 ? "COMPREHENSIVE MOCK CURRICULUM" : "SCIENTIFIC INQUIRY & PRACTICAL LABS",
                strandName: "STRAND 1 TO STRAND 5",
                strandCode: "S1-S5",
                subStrand: paperNum === 1 
                    ? "Final Benchmark Standards Mock 10 Objective" 
                    : "Final Benchmark Standards Mock 10 Practical & Theory",
                gradeTier: "Junior Secondary (JHS)",
                meta: paperNum === 1 ? "Paper 1 (40 Questions) • 45 mins • 40 Marks" : "Section A & B (5 Questions) • 105 mins • 100 Marks",
                description: paperNum === 1 
                    ? "Standardized 40-question objective examination synthesizing NaCCA BECE science curriculum standards with balanced key distribution (10 A, 10 B, 10 C, 10 D)."
                    : "Standardized practical and theory essay examination featuring principle of moments, salt synthesis by neutralization, variegated leaf starch test, and 4-course crop rotation.",
                difficulty: paperNum === 1 ? "Core" : "Advanced",
                kind: "mock_suite",
                setId: paperNum === 1 ? "paper_mock_10" : "paper_mock_10_p2",
                topicId: "mock_exams",
                format: paperNum === 1 ? "multiple_choice" : "structured_essay",
                paperType: paperNum,
                year: 2026,
            ...
            await handleLaunchModule({
                title: paperNum === 1 
                    ? "BECE Integrated Science Mock 11 (Set 142 Objective)" 
                    : "BECE Integrated Science Mock 11 (Set 142 Practical & Theory)",
                domain: paperNum === 1 ? "COMPREHENSIVE MOCK CURRICULUM" : "SCIENTIFIC INQUIRY & PRACTICAL LABS",
                strandName: "STRAND 1 TO STRAND 5",
                strandCode: "S1-S5",
                subStrand: paperNum === 1 
                    ? "Electricity, Electronics & Applied Technology Mock 11 Objective" 
                    : "Electricity, Electronics & Applied Technology Mock 11 Practical & Theory",
                gradeTier: "Junior Secondary (JHS)",
                meta: paperNum === 1 ? "Paper 1 (40 Questions) • 45 mins • 40 Marks" : "Section A & B (5 Questions) • 105 mins • 100 Marks",
                description: paperNum === 1 
                    ? "Standardized 40-question objective examination synthesizing NaCCA BECE science curriculum standards with balanced key distribution (10 A, 10 B, 10 C, 10 D)."
                    : "Standardized practical and theory essay examination featuring circuit troubleshooting, capacitor charging & LED flash behavior, solar irrigation pumps, and e-waste management.",
                difficulty: paperNum === 1 ? "Core" : "Advanced",
                kind: "mock_suite",
                setId: paperNum === 1 ? "paper_mock_11" : "paper_mock_11_p2",
                topicId: "mock_exams",
                format: paperNum === 1 ? "multiple_choice" : "structured_essay",
                paperType: paperNum,
                year: 2026,
                ...
                isLoadingSet ? (
                    ...
                    <QuestionRunner
                        ...
                        onProceedToPaper2={() => {
                            ...
                            } else if (activeQuestionSet?.id === 'bece_2018_p1' || activeQuestionSet?.id === 'bece_2018') {
                                handleLaunchModule({ setId: 'bece_2018_p2', title: 'BECE English Language 2018 (Paper 2: Essay & Literature)', paperType: 2, subject: 'English Language' });
                            } else if (activeQuestionSet?.id === 'bece_2017_p1' || activeQuestionSet?.id === 'bece_2017') {
                                handleLaunchModule({ setId: 'bece_2017_p2', title: 'BECE English Language 2017 (Paper 2: Essay & Literature)', paperType: 2, subject: 'English Language' });
                            } else if (activeQuestionSet?.id === 'bece_2016_p1' || activeQuestionSet?.id === 'bece_2016') {
                                handleLaunchModule({ setId: 'bece_2016_p2', title: 'BECE English Language 2016 (Paper 2: Essay & Literature)', paperType: 2, subject: 'English Language' });
                            } else if (activeQuestionSet?.id === 'bece_2015_p1' || activeQuestionSet?.id === 'bece_2015') {
                                handleLaunchModule({ setId: 'bece_2015_p2', title: 'BECE English Language 2015 (Paper 2: Essay & Comprehension)', paperType: 2, subject: 'English Language' });
                            } else if (activeQuestionSet?.id === 'bece_2014_p1' || activeQuestionSet?.id === 'bece_2014') {
                                handleLaunchModule({ setId: 'bece_2014_p2', title: 'BECE English Language 2014 (Paper 2: Essay & Comprehension)', paperType: 2, subject: 'English Language' });
                            } else if (activeQuestionSet?.id === 'bece_2013_p1' || activeQuestionSet?.id === 'bece_2013') {
                                handleLaunchModule({ setId: 'bece_2013_p2', title: 'BECE English Language 2013 (Paper 2: Essay & Comprehension)', paperType: 2, subject: 'English Language' });
                            } else if (activeQuestionSet?.id === 'bece_2012_p1' || activeQuestionSet?.id === 'bece_2012') {
                                handleLaunchModule({ setId: 'bece_2012_p2', title: 'BECE English Language 2012 (Paper 2: Essay & Comprehension)', paperType: 2, subject: 'English Language' });
                            } else if (activeQuestionSet?.id === 'bece_2011_p1' || activeQuestionSet?.id === 'bece_2011') {
                                handleLaunchModule({ setId: 'bece_2011_p2', title: 'BECE English Language 2011 (Paper 2: Essay & Comprehension)', paperType: 2, subject: 'English Language' });
                            } else if (activeQuestionSet?.id === 'bece_2010_p1' || activeQuestionSet?.id === 'bece_2010') {
                                handleLaunchModule({ setId: 'bece_2010_p2', title: 'BECE English Language 2010 (Paper 2: Essay & Comprehension)', paperType: 2, subject: 'English Language' });
                            } else if (activeQuestionSet?.id === 'bece_2009_p1' || activeQuestionSet?.id === 'bece_2009') {
                                handleLaunchModule({ setId: 'bece_2009_p2', title: 'BECE English Language 2009 (Paper 2: Essay Writing)', paperType: 2, subject: 'English Language' });
                            } else if (activeQuestionSet?.id === 'bece_2008_p1' || activeQuestionSet?.id === 'bece_2008') {
                                handleLaunchModule({ setId: 'bece_2008_p2', title: 'BECE English Language 2008 (Paper 2: Essay Writing)', paperType: 2, subject: 'English Language' });
                            } else if (activeQuestionSet?.id === 'bece_2007_p1' || activeQuestionSet?.id === 'bece_2007') {
                                handleLaunchModule({ setId: 'bece_2007_p2', title: 'BECE English Language 2007 (Paper 2: Essay Writing)', paperType: 2, subject: 'English Language' });
                            } else if (activeQuestionSet?.id === 'bece_2006_p1' || activeQuestionSet?.id === 'bece_2006') {
                                handleLaunchModule({ setId: 'bece_2006_p2', title: 'BECE English Language 2006 (Paper 2: Essay Writing)', paperType: 2, subject: 'English Language' });
                            } else if (activeQuestionSet?.id === 'bece_2005_p1' || activeQuestionSet?.id === 'bece_2005') {
                                handleLaunchModule({ setId: 'bece_2005_p2', title: 'BECE English Language 2005 (Paper 2: Essay Writing)', paperType: 2, subject: 'English Language' });
                            } else if (activeQuestionSet?.id === 'bece_2004_p1' || activeQuestionSet?.id === 'bece_2004') {
                                handleLaunchModule({ setId: 'bece_2004_p2', title: 'BECE English Language 2004 (Paper 2: Essay Writing)', paperType: 2, subject: 'English Language' });
                            } else if (activeQuestionSet?.id === 'bece_2003_p1' || activeQuestionSet?.id === 'bece_2003') {
                                handleLaunchModule({ setId: 'bece_2003_p2', title: 'BECE English Language 2003 (Paper 2: Essay Writing)', paperType: 2, subject: 'English Language' });
                            } else if (activeQuestionSet?.id === 'bece_2001_p1' || activeQuestionSet?.id === 'bece_2001') {
