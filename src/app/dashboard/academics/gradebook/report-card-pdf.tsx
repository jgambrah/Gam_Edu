...
export function GenerateReportCard(props: any) {
    // State to hold the loaded PDF library
    ...
    // 3. Destructure components from the loaded library
    const { Document, Page, Text, View, StyleSheet, PDFDownloadLink } = PdfLib;

    // 4. Define Styles (Must happen after library loads)
        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={{flexDirection: 'row', marginTop: 40, justifyContent: 'space-between', paddingHorizontal: 20}}>
                    <View style={{borderTop: 1, width: 150, alignItems: 'center'}}><Text style={{fontSize: 9, marginTop: 5}}>Class Teacher</Text></View>
                    <View style={{borderTop: 1, width: 150, alignItems: 'center'}}><Text style={{fontSize: 9, marginTop: 5}}>Principal</Text></View>
                </View>
