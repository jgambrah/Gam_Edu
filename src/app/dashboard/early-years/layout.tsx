  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50">
      <header className="bg-white shadow-sm p-4 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3 cursor-pointer" onClick={handleHome}>
            ...
            <h1 className="text-2xl font-extrabold text-gray-800 tracking-tight">Early<span className="text-pink-500">Years</span></h1>
          </div>
      ...
      <footer className="bg-white border-t p-6 text-center text-gray-400 font-medium">
        <p>© 2024 Early Years Education • Play. Learn. Grow.</p>
