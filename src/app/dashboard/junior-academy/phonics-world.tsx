...
const IconRenderer = ({ iconName, className }: { iconName: string, className?: string }) => {
    ...
    if (!IconComponent) {
      console.error(`❌ Missing or invalid icon for key: ${iconName}`);
  ...
  return (
    <div className="w-full relative font-black">
      ...
      <div className="w-full bg-white p-12 rounded-[4rem] shadow-2xl border-8 border-rose-100 flex flex-col items-center min-h-[600px] animate-in zoom-in">
        ...
        <button onClick={() => setIndex((index + 1) % data.length)} className="mt-8 text-rose-300 uppercase text-[10px] tracking-widest font-black" >Next Word</button>
      </div>
