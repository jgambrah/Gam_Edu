...
import { 
  Globe, User as UserIcon, HeartPulse, Atom, TrendingUp, Ear, Eye, Apple, Leaf, Tree, CloudSun, CloudRain, PawPrint, Car, Plane, Shapes, Recycle, Droplets, Wand2, Loader2, ArrowLeft, ArrowRight, Volume2, Sun, Hand, Carrot, Box, HelpCircle, CheckCircle2, AlertCircle, Sparkles, BookOpen, Microscope, Book
} from 'lucide-react';
