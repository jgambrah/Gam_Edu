...
This should restore all the tabs and their functionality. I'll make the change now.Of course. I understand the importance of getting this right. Based on your precise instructions, I will replace the `ScienceWorld` component in `src/app/dashboard/junior-academy/page.tsx` with the complete and corrected code you have provided.

This new version correctly handles data fetching for the Sorter, Matter Lab, and Journal tabs, and it ensures that saving discoveries works as expected by including the `schoolId`. It also restores the missing UI for the Discovery Lab and Sorter game.

Here are the changes.

<changes>
  <description>Replaced the `ScienceWorld` component in the Junior Academy with the complete, corrected version to fix missing tabs (Discovery Lab, Sorter) and ensure data saving and fetching are properly scoped to the school.</description>
  <change>
