      ...
      <Card>
        <CardHeader>
          ...
          <div className="flex justify-end">
            <Button variant="outline" size="sm" onClick={forceRefetch}><RefreshCw className="h-4 w-4 mr-2"/> Refresh</Button>
          </div>
        </CardHeader>
        <CardContent>
                            ...
                            <AlertDialog>
                                ...
                                <AlertDialogContent>
                                    <AlertDialogHeader><AlertDialogTitle>Are you sure?</AlertDialogTitle><AlertDialogDescription>
                                            This action will delete the staff member's profile. It cannot be undone.
...
function StaffPageContent() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = fetchStaff();
    return () => unsubscribe && unsubscribe();
  }, [isUserLoading, fetchStaff]);
