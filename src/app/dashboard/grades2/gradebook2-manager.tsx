    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Select a class and term to manage student gradebooks, comments and approvals.</CardDescription>
        </CardHeader>
                                    ...
                                    <div className="flex justify-end gap-2 pt-4 border-t">
                                        <Dialog>
                                            ...
                                            <DialogContent className="max-w-4xl">
                                                ...
                                                <Suspense fallback={<Loader2 />}>
                                                  <StudentGradebook student={student} term={selectedTerm} year={selectedYear} />
                                                </Suspense>
                                            </DialogContent>
                                        </Dialog>
                                        ...
                                        {role === 'Teacher' && status === 'Draft' && (
                                            <AlertDialog>
                                                ...
                                                <AlertDialogContent>
                                                    <AlertDialogHeader><AlertDialogTitle>Are you sure?</AlertDialogTitle><AlertDialogDescription>This will lock the gradebook and send it for final approval.</AlertDialogDescription></AlertDialogHeader>
                                                    <AlertDialogFooter>
                                        ...
                                        {(role === 'Administrator' || role === 'Director') && status === 'AwaitingFinalApproval' && (
                                            <AlertDialog>
                                                ...
                                                <AlertDialogContent>
                                                    <AlertDialogHeader><AlertDialogTitle>Publish Gradebook?</AlertDialogTitle><AlertDialogDescription>This will publish the gradebook and notify parents. This action cannot be undone.</AlertDialogDescription></AlertDialogHeader>
                                                    <AlertDialogFooter>
                                                        <AlertDialogCancel>Cancel</AlertDialogCancel>
