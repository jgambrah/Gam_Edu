    ...
    >
      ...
      <div className="px-8 pb-4 flex-1 relative z-10">
        <section className="grid grid-cols-2 gap-8 my-4 text-xs bg-slate-100/40 p-4 rounded-lg border border-slate-200">
          ...
          <div className="text-right">
            <h3 className="text-[8px] uppercase font-black text-slate-900 tracking-widest mb-0.5">Payment Details</h3>
            <p className="font-bold text-slate-700 leading-tight"><span className="font-extrabold text-slate-900">Date:</span> {paymentDate}</p>
            <p className="font-bold text-slate-700 leading-tight"><span className="font-extrabold text-slate-900">Method:</span> {payment.method}</p>
            {payment.notes && <p className="font-bold text-slate-700 leading-tight"><span className="font-extrabold text-slate-900">Ref:</span> {payment.notes}</p>}
          </div>
        </section>
        ...
        <section className="flex justify-end mt-5">
            <div className="w-2/3 space-y-2">
                ...
                >
                    ...
                    <span className="font-black text-sm font-mono">GH₵ {totalBalance.toFixed(2)}</span>
                </div>
                
                <p className="text-[8px] text-slate-500 font-bold italic text-right pt-0.5 uppercase">
