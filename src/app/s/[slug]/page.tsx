        ...
        <div className="min-h-screen bg-white font-sans text-slate-900">
            ...
            <div className="max-w-7xl mx-auto px-6 py-24 space-y-32">
                ...
                <section id="about" className="grid md:grid-cols-2 gap-20 items-start">
                    ...
                    <div className="space-y-8">
                        {ytId ? (
                            <div className="rounded-[2.5rem] overflow-hidden shadow-2xl aspect-video border-[12px] border-slate-50 ring-1 ring-slate-200">
                                <iframe width="100%" height="100%" src={`https://www.youtube.com/embed/${ytId}?rel=0&modestbranding=1`} title="Promo Video" frameBorder="0" allowFullScreen></iframe>
                            </div>
                        ) : (
                            <div className="bg-slate-100 rounded-[2.5rem] aspect-video flex items-center justify-center border-4 border-dashed border-slate-200">
                                <Play className="h-16 w-16 text-slate-300" />
                            </div>
                        )}
                        
                        <div className="p-8 bg-slate-900 text-white rounded-[2.5rem] shadow-xl space-y-6">
                            <h3 className="text-2xl font-black uppercase italic tracking-tighter">Get in Touch</h3>
                            <div className="space-y-4">
                                <div className="flex items-start gap-4 text-slate-300">
                                    <MapPin className="h-6 w-6 text-indigo-400 shrink-0"/> 
                                    <span className="font-bold">{school.address || "Address not provided"}</span>
                                </div>
                                <div className="flex items-center gap-4 text-slate-300">
                                    <Phone className="h-6 w-6 text-indigo-400 shrink-0"/> 
                                    <span className="font-bold">{school.phone || "Phone not provided"}</span>
                                </div>
                                <div className="flex items-center gap-4 text-slate-300">
