...
const {
    ...
    CaseSensitive, BookOpen, Utensils, Trash2, Calculator, Shapes, ObjectGroup
} = LucideIcons;
...
export const ModuleContainer: React.FC<{ title: string; children: React.ReactNode; icon: string }> = ({ title, children, icon }) => {
    ...
    if (!started) {
        return (
            <div className="text-center p-12 bg-white rounded-3xl shadow-lg animate-in fade-in zoom-in">
...
export const NumbersMainModule: React.FC<{ onSound: (t: string) => void, schoolId: string }> = ({ onSound, schoolId }) => {
...
/* --- 3. NUMBER SEQUENCE --- */
export const NumberSequenceModule: React.FC<{ onSound: (t: string) => void, schoolId: string }> = ({ onSound, schoolId }) => {
...
export const NumberComparisonModule: React.FC<{ onSound: (t: string) => void, schoolId: string }> = ({ onSound, schoolId }) => {
...
/* --- 5. NUMBER WORDS --- */
export const NumberWordsModule: React.FC<{ onSound: (t: string) => void, schoolId: string }> = ({ onSound, schoolId }) => {
...
/* --- 6. NUMBER BONDS --- */
export const NumberBondsModule: React.FC<{ onSound: (t: string) => void }> = ({ onSound }) => {
...
/* --- 7. ADDITION --- */
export const AdditionModule: React.FC<{ onSound: (t: string) => void, schoolId: string }> = ({ onSound, schoolId }) => {
...
/* --- 8. SUBTRACTION --- */
export const SubtractionModule: React.FC<{ onSound: (t: string) => void, schoolId: string }> = ({ onSound, schoolId }) => {
...
/* --- 9. TENS AND UNITS --- */
export const TensUnitsModule: React.FC<{ onSound: (t: string) => void, schoolId: string }> = ({ onSound, schoolId }) => {
