...
export const SET_JHS_MASTERY_SERIES_63: CurriculumQuestionSet = {
  id: "jhs-math-mastery-series-63",
  title: "Junior Core Mathematics - Structured Problem-Solving Series (Set 63)",
  tier: "Junior Secondary (JHS)",
  subject: "Mathematics",
  topic: "Comprehensive Structured Problem Solving (2021 BECE Variant)",
  ...
  questions: [
    {
        "id": "q01",
        "title": "Question 1: Venn Diagram Algebraic Sets & Laws of Indices",
        "totalMarks": 15,
        "points": 15,
    ...
    {
        "id": "q02",
        "title": "Question 2: Grouping Factorization, Rational Cross-Multiplication & Ratio Sharing",
        "totalMarks": 15,
        "points": 15,
        "format": "structured_essay",
        "prompt": "Answer all parts of this question:",
        ...
        "parts": [
            {
                ...
                "hint": "Show all mathematical derivations, state formulas clearly, and simplify your final result.",
                "modelAnswer": "Group terms in pairs:\n$$= (4mx - nx) + (12m - 3n)$$\nFactor out common factors:\n$$= x(4m - n) + 3(4m - n)$$\n$$= (4m - n)(x + 3)$$.",
    ...
    {
        "id": "q03",
        "title": "Question 3: Column Vector Subtraction, Integer Word Problem & Hall Floor Tiling",
        "totalMarks": 15,
        "points": 15,
        "format": "structured_essay",
        "prompt": "Answer all parts of this question:",
        ...
        "parts": [
            ...
            },
            {
                ...
                "hint": "Show all mathematical derivations, state formulas clearly, and simplify your final result.",
                "modelAnswer": "Let the first number be $x$. The second number is $2x$.\n$$x + 2x = 72$$\n$$3x = 72 \\implies x = 24$$\n$$\\text{First number} = 24$$\n$$\\text{Second number} = 2 \\times 24 = 48$$.",
    ...
    {
        "id": "q04",
        "title": "Question 4: Item Percentages, Linear Mapping Relations & Travel Speed/Distance",
        "totalMarks": 15,
        "points": 15,
        "format": "structured_essay",
        "prompt": "Answer all parts of this question:",
    ...
    {
        "id": "q05",
        "title": "Question 5: Binomial Product Expansion, Circle Center Angles & Linear Cost Modeling",
        "totalMarks": 15,
        "points": 15,
        "format": "structured_essay",
        "prompt": "Answer all parts of this question:",
        ...
        "parts": [
            ...
            },
            {
                ...
                "hint": "Show all mathematical derivations, state formulas clearly, and simplify your final result.",
                "modelAnswer": "Angles at a point sum to $360^\\circ$:\n$$50 + 70 + 80 + 2x + 6x = 360$$\n$$200 + 8x = 360$$\n$$8x = 360 - 200 = 160$$\n$$x = \\frac{160}{8} = 20$$.",
    ...
    {
        "id": "q06",
        "title": "Question 6: Frequency Table Completion, Modal Score & Mean Computation",
        "totalMarks": 15,
        "points": 15,
        "format": "structured_essay",
        "prompt": "Answer all parts of this question:",
        ...
        "parts": [
            ...
            },
            {
                ...
                "hint": "Show all mathematical derivations, state formulas clearly, and simplify your final result.",
                "modelAnswer": "$$\\text{Mean } (\\bar{x}) = \\frac{\\sum fx}{\\sum f} = \\frac{128}{39} \\approx 3.282$$\nRounding to the nearest whole number gives **3 pencils**.",
