 ...
 *   - svgQ1aReproductiveSystems: Human female and male reproductive systems [IMG_2614.jpg]
 *   - svgQ1bFarmTools: Horticultural farm tools (Pickaxe A, Dibber B, Hand fork C) [IMG_2613.jpg]
...
export const svgQ1aReproductiveSystems = "<div class=\"my-4 flex justify-center\"><svg viewBox='0 0 380 230' width='100%' height='210' style='max-width: 480px;' xmlns='http://www.w3.org/2000/svg'><rect width='100%' height='100%' rx='8' fill='#0f172a' stroke='#334155' stroke-width='1.5'/><!-- Female Reproductive System (Left) --><g transform='translate(15, 25)'><!-- Uterus Body I --><path d='M 70 50 C 55 50 45 80 50 115 L 60 145 L 80 145 L 90 115 C 95 80 85 50 70 50 Z' fill='#1e293b' stroke='#f43f5e' stroke-width='2'/><text x='70' y='80' font-size='10' font-weight='bold' fill='#f43f5e' text-anchor='middle'>I (Uterus)</text><!-- Left Fallopian Tube II & Ovary V --><path d='M 55 55 C 35 40 15 45 10 65 L 12 75' fill='none' stroke='#38bdf8' stroke-width='2.5'/><text x='25' y='35' font-size='9' font-weight='bold' fill='#38bdf8'>II (Oviduct)</text><!-- Ovary V --><ellipse cx='12' cy='85' rx='7' ry='10' fill='#facc15' stroke='#ca8a04' stroke-width='1.5'/><text x='0' y='105' font-size='9' font-weight='bold' fill='#facc15'>V (Ovary)</text><!-- Right Fallopian Tube & Ovary --><path d='M 85 55 C 105 40 125 45 130 65 L 128 75' fill='none' stroke='#38bdf8' stroke-width='2.5'/><ellipse cx='128' cy='85' rx='7' ry='10' fill='#facc15' stroke='#ca8a04' stroke-width='1.5'/><!-- Cervix III & Vagina IV --><line x1='60' y1='145' x2='80' y2='145' stroke='#cbd5e1' stroke-width='2'/><text x='95' y='145' font-size='9' font-weight='bold' fill='#cbd5e1'>III (Cervix)</text><path d='M 60 145 L 63 175 L 77 175 L 80 145' fill='none' stroke='#f43f5e' stroke-width='2'/><text x='70' y='190' font-size='9' font-weight='bold' fill='#f43f5e' text-anchor='middle'>IV (Vagina)</text><text x='70' y='202' font-size='9' font-weight='bold' fill='#cbd5e1' text-anchor='middle'>Female System</text></g><!-- Divider Line --><line x1='180' y1='20' x2='180' y2='210' stroke='#334155' stroke-width='1.5' stroke-dasharray='4,3'/><!-- Male Reproductive System (Right) --><g transform='translate(200, 25)'><!-- Pelvic & Abdominal Outline --><path d='M 25 15 C 30 60 35 110 50 150' fill='none' stroke='#64748b' stroke-width='1.5'/><!-- Bladder & Prostate Region --><ellipse cx='75' cy='65' rx='16' ry='14' fill='#1e293b' stroke='#64748b' stroke-width='1.5'/><!-- Vas Deferens (Sperm Duct) VI --><path d='M 125 145 C 115 70 85 55 75 75 L 75 115' fill='none' stroke='#38bdf8' stroke-width='2.5'/><text x='110' y='45' font-size='9' font-weight='bold' fill='#38bdf8'>VI (Sperm duct)</text><!-- Testis VII inside Scrotum VIII --><path d='M 110 130 C 105 165 145 175 140 135' fill='none' stroke='#94a3b8' stroke-width='2'/><text x='148' y='160' font-size='9' font-weight='bold' fill='#94a3b8'>VIII (Scrotum)</text><!-- Testis VII --><ellipse cx='125' cy='145' rx='9' ry='12' fill='#facc15' stroke='#ca8a04' stroke-width='1.5'/><text x='145' y='142' font-size='9' font-weight='bold' fill='#facc15'>VII (Testis)</text><!-- Urethra & Penis Structure --><path d='M 75 115 C 75 130 95 140 95 155' fill='none' stroke='#38bdf8' stroke-width='3'/><text x='100' y='202' font-size='9' font-weight='bold' fill='#cbd5e1' text-anchor='middle'>Male System</text></g></svg></div>";
export const svgQ1bFarmTools = "<div class=\"my-4 flex justify-center\"><svg viewBox='0 0 380 170' width='100%' height='155' style='max-width: 480px;' xmlns='http://www.w3.org/2000/svg'><rect width='100%' height='100%' rx='8' fill='#0f172a' stroke='#334155' stroke-width='1.5'/><!-- Tool A: Mattock / Pickaxe (Left) --><g transform='translate(20, 20)'><!-- Wooden Handle --><rect x='0' y='38' width='80' height='10' rx='3' fill='#a16207' stroke='#78350f' stroke-width='1.2'/><!-- Heavy Iron Head (Pick on one side, Mattock blade on other) --><path d='M 75 10 L 88 10 L 98 43 L 88 78 L 78 85 L 85 43 Z' fill='#64748b' stroke='#cbd5e1' stroke-width='1.5'/><text x='50' y='110' font-size='11' font-weight='bold' fill='#38bdf8' text-anchor='middle'>A (Pickaxe / Mattock)</text></g><!-- Tool B: Dibber (Middle) --><g transform='translate(160, 20)'><!-- Pointed Wooden Stick Dibber --><ellipse cx='15' cy='12' rx='7' ry='4' fill='#d97706' stroke='#92400e'/><path d='M 8 12 L 13 88 L 17 88 L 22 12 Z' fill='#b45309' stroke='#78350f' stroke-width='1.5'/><text x='15' y='110' font-size='11' font-weight='bold' fill='#f59e0b' text-anchor='middle'>B (Dibber)</text></g><!-- Tool C: Hand Fork / Garden Fork (Right) --><g transform='translate(230, 25)'><!-- Metal Prongs --><rect x='0' y='10' width='35' height='6' rx='1' fill='#94a3b8'/><line x1='35' y1='13' x2='35' y2='38' stroke='#cbd5e1' stroke-width='2.5'/><line x1='0' y1='16' x2='0' y2='42' stroke='#94a3b8' stroke-width='2.5'/><line x1='12' y1='16' x2='12' y2='45' stroke='#94a3b8' stroke-width='2.5'/><line x1='23' y1='16' x2='23' y2='45' stroke='#94a3b8' stroke-width='2.5'/><line x1='35' y1='16' x2='35' y2='42' stroke='#94a3b8' stroke-width='2.5'/><!-- Shaft & Wooden Handle --><path d='M 17 10 L 17 -5 C 17 -15 35 -15 45 -5 L 65 15 C 75 25 65 35 55 25 Z' fill='#a16207' stroke='#78350f' stroke-width='1.5' transform='rotate(42 20 10)'/><text x='65' y='105' font-size='11' font-weight='bold' fill='#10b981' text-anchor='middle'>C (Hand Fork)</text></g><text x='190' y='150' font-size='8' font-weight='bold' fill='#cbd5e1' text-anchor='middle'>HORTICULTURAL FARM TOOLS FOR TILLAGE, NURSERY AND WEEDING</text></svg></div>";
