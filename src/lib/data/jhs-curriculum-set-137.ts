/**
 * SET 137: BECE Integrated Science Mock 6 (National Standards-Compliant Benchmark Suite)
...
export const SET_BECE_MOCK_6_SCIENCE_P1 = {
  year: "Mock 6",
  isMock: true,
  setNumber: 137,
  subject: "Integrated Science",
  examination: "WAEC BECE Integrated Science (Standard Mock 6)",
...
export const SET_BECE_MOCK_6_SCIENCE_P2 = {
  year: "Mock 6",
  isMock: true,
  setNumber: 137,
  subject: "Integrated Science",
...
export const SET_BECE_MOCK_6_SCIENCE_COMPLETE = {
  id: "mock_6",
  setNumber: 137,
  subject: "Integrated Science",
  title: "BECE Integrated Science Mock 6 (National Standards-Compliant Benchmark Suite)",
  totalDurationMinutes: 150,
  paper1: SET_BECE_MOCK_6_SCIENCE_P1,
  paper2: SET_BECE_MOCK_6_SCIENCE_P2,
  metadata: {
    isMock: true,
    isMockExam: true,
    setNumber: 137,
