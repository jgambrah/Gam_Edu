...
export const COMPREHENSIVE_QUESTION_CATALOG: AssignmentExamOption[] = [
  ...
  },
  {
    ...
    subject: 'Integrated Science',
    gradeTier: 'Junior High (JHS)',
    badge: 'BECE Science Set 82',
    questionCount: 40,
    topic: '2019 BECE Integrated Science Standardized CBT',
    description: 'Calibrated isomorphic practice variant of 2019 BECE Integrated Science Paper 1 with KaTeX equations, vector SVGs, and step-by-step worked solutions.'
  },
{
  ...
  },
  {
    ...
    subject: 'Integrated Science',
    gradeTier: 'Junior High (JHS)',
    badge: 'BECE Science Set 88',
    questionCount: 40,
    topic: '2022 BECE Integrated Science Standardized CBT',
    description: 'Calibrated isomorphic practice variant of 2022 BECE Integrated Science Paper 1 with KaTeX equations, vector SVGs (Capacitor-LED circuit, NPN transistor), and step-by-step diagnostic solutions.'
  },
  {
