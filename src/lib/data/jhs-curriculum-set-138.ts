/**
 * SET 138: BECE Integrated Science Mock 7 (100% NaCCA JHS Standards-Calibrated)
...
export const SET_BECE_MOCK_7_SCIENCE_P1 = {
  year: "Mock 7",
  isMock: true,
  setNumber: 138,
  subject: "Integrated Science",
  examination: "WAEC BECE Integrated Science (Standard Mock 7)",
...
export const SET_BECE_MOCK_7_SCIENCE_P2 = {
  year: "Mock 7",
  isMock: true,
  setNumber: 138,
  subject: "Integrated Science",
...
export const SET_BECE_MOCK_7_SCIENCE_COMPLETE = {
  id: "mock_7",
  setNumber: 138,
  subject: "Integrated Science",
  title: "BECE Integrated Science Mock 7 (100% NaCCA JHS Standards-Calibrated)",
  totalDurationMinutes: 150,
  paper1: SET_BECE_MOCK_7_SCIENCE_P1,
  paper2: SET_BECE_MOCK_7_SCIENCE_P2,
  metadata: {
    isMock: true,
    isMockExam: true,
    setNumber: 138,
